...
public final class Rnd {
	/**
	 * This class extends {@link java.util.Random} but do not compare and store
	 * atomically.<br>
	 * Instead it`s using a simple volatile flag to ensure reading and storing the
	 * whole 64bit seed chunk.<br>
	 * This implementation is much faster on parallel access, but may generate the
	 * same seed for 2 threads.
	 * 
	 * @author Forsaiken
	...
	public static final class RandomContainer {
		 ...
		 * @see net.sf.l2j.util.Rnd#nextDouble()
		 */
		...
		/**
		 * Fill the given array with random byte numbers from Byte.MIN_VALUE(inclusive)
		 * to Byte.MAX_VALUE(inclusive)
		 * 
		 * @param array
	...
	public static enum RandomType {
		...
		/**
		 * Like {@link net.sf.l2j.util.Rnd.RandomType#UNSECURE_ATOMIC}.<br>
		 * Each thread has it`s own random instance.<br>
		 * Provides best parallel access speed.
		 * 
		 * @see net.sf.l2j.util.Rnd.ThreadLocalRandom
		 */
		 ...
		 * 
		 * @see net.sf.l2j.util.Rnd.NonAtomicRandom
		 */
		UNSECURE_VOLATILE
	}
	 ...
	 * This class extends {@link java.util.Random} but do not compare and store
	 * atomically.<br>
	 * Instead it`s using thread local ensure reading and storing the whole 64bit
	 * seed chunk.<br>
	...
	/**
	 * @see net.sf.l2j.util.Rnd#get(int n)
	 */
