...
import com.util.services.ConfigFiles;
...
public final class Config
{
	...
	public static HashMap<Integer, Integer> CLAN_SKILLS;
	...
	public static void CustomConfig()
	{
		try
		{
			...
			MESSAGE_ON_ENTER = p.getProperty("MessageOnEnter", "L2L2jSigmo Project!");
			/** Online */
			...
			CLAN_LEVEL = Byte.parseByte(p.getProperty("ClanSetLevel", "8"));
			REPUTATION_QUANTITY = Integer.parseInt(p.getProperty("ReputationScore", "10000"));
			ENABLE_CLAN_SYSTEM = Boolean.parseBoolean(p.getProperty("EnableClanSystem", "True"));
			if(ENABLE_CLAN_SYSTEM)
			{
			String AioSkillsSplit[] = p.getProperty("ClanSkills", "").split(";");
			...
			LEAVE_BUFFS_ON_DIE = Boolean.parseBoolean(p.getProperty("NoRemoveBuffsOnDie", "False"));
			p.clear();
		}
		catch(Exception e)
		{
	...
	public static boolean TVT_AUTO_MODE;
	public static int TVT_TEAMS_NUM;
	public static int TVT_PLAYER_LEVEL_MIN;
	public static int TVT_PLAYER_LEVEL_MAX;
	...
	public static boolean TVT_ALLOW_SCROLL;
	...
	public static String[] TVT_REWARD;
	public static String[] TVT_REWARD_TOP;
	public static String[] TVT_EVENT_INTERVAL;
	public static String[] TVT_NPC_LOC;
	public static int TVT_NPC_X;
	public static int TVT_NPC_Y;
	public static int TVT_NPC_Z;
	public static String TVT_NPC_LOC_NAME;
	public static String[] TVT_DEAD_LOC;
	public static int TVT_DEAD_X;
	public static int TVT_DEAD_Y;
	public static int TVT_DEAD_Z;
	public static int TVT_RES_TIME;
	public static int TVT_MIN_PLAYERS;
	public static int TVT_FIGHT_TIME;
	public static int TVT_COUNTDOWN_TIME;
	public static ArrayList<Integer> TVT_DOORS_TO_CLOSE = new ArrayList<Integer>();
	public static ArrayList<Integer> TVT_DOORS_TO_OPEN = new ArrayList<Integer>();
	/** CTF */
	...
	//============================================================
	public static void EventsConfig()
	{
		try
		{
			L2Properties p = new L2Properties(ConfigFiles.EVENTS_INI);

			/** TVT */
			TVT_AUTO_MODE = TypeFormat.parseBoolean(p.getProperty("TvTAutoMode", "false"));
			TVT_TEAMS_NUM = TypeFormat.parseInt(p.getProperty("TvTTeamsNum", "2"));
			TVT_PLAYER_LEVEL_MIN = TypeFormat.parseInt(p.getProperty("TvTPlayerLevelMin", "1"));
			TVT_PLAYER_LEVEL_MAX = TypeFormat.parseInt(p.getProperty("TvTPlayerLevelMax", "80"));
			TVT_ALLOW_INTERFERENCE = TypeFormat.parseBoolean(p.getProperty("TvTAllowInterference", "false"));
			TVT_ALLOW_POTIONS = TypeFormat.parseBoolean(p.getProperty("TvTAllowPotions", "false"));
			TVT_ALLOW_SUMMON = TypeFormat.parseBoolean(p.getProperty("TvTAllowSummon", "false"));
			TVT_ALLOW_SCROLL = TypeFormat.parseBoolean(p.getProperty("TvTAllowScrolls", "false"));
			TVT_ON_START_REMOVE_ALL_EFFECTS = TypeFormat.parseBoolean(p.getProperty("TvTOnStartRemoveAllEffects", "true"));
			TVT_ON_START_UNSUMMON_PET = TypeFormat.parseBoolean(p.getProperty("TvTOnStartUnsummonPet", "true"));
			TVT_ALLOW_ENEMY_HEALING = TypeFormat.parseBoolean(p.getProperty("TvTAllowEnemyHealing", "false"));
			TVT_ALLOW_TEAM_CASTING = TypeFormat.parseBoolean(p.getProperty("TvTAllowTeamBuff", "false"));
			TVT_ALLOW_TEAM_ATTACKING = TypeFormat.parseBoolean(p.getProperty("TvTAllowTeamAttacking", "false"));
			TVT_JOIN_CURSED = TypeFormat.parseBoolean(p.getProperty("TvTJoinWithCursedWeapon", "true"));
			TVT_PRICE_NO_KILLS = TypeFormat.parseBoolean(p.getProperty("TvTPriceNoKills", "false"));
			TVT_AURA = TypeFormat.parseBoolean(p.getProperty("TvTAura", "true"));
			TVT_EVEN_TEAMS = p.getProperty("TvTEvenTeams", "SHUFFLE");
			TVT_REWARD = p.getProperty("TvTReward", "57:1000").split(";");
			TVT_REWARD_TOP = p.getProperty("TvTRewardTop", "57:1000").split(";");
			TVT_ANNOUNCE_REWARD = TypeFormat.parseBoolean(p.getProperty("TvTAnnounceReward", "false"));
			TVT_EVENT_INTERVAL = p.getProperty("TvTEventInterval", "20:00").split(",");
			TVT_NPC_LOC = p.getProperty("TvTNpcLoc", "147711,-55236,-2737").split(",");
			TVT_NPC_X = TypeFormat.parseInt(TVT_NPC_LOC[0]);
			TVT_NPC_Y = TypeFormat.parseInt(TVT_NPC_LOC[1]);
			TVT_NPC_Z = TypeFormat.parseInt(TVT_NPC_LOC[2]);
			TVT_NPC_LOC_NAME = p.getProperty("TvTNpcLocName", "Goddard Town");
			TVT_DEAD_LOC = p.getProperty("TvTDeadLoc", "147711,-55236,-2737").split(",");
			TVT_DEAD_X = TypeFormat.parseInt(TVT_DEAD_LOC[0]);
			TVT_DEAD_Y = TypeFormat.parseInt(TVT_DEAD_LOC[1]);
			TVT_DEAD_Z = TypeFormat.parseInt(TVT_DEAD_LOC[2]);
			TVT_RES_TIME = TypeFormat.parseInt(p.getProperty("TvTResTime", "1"));
			TVT_MIN_PLAYERS = TypeFormat.parseInt(p.getProperty("TvTMinPlayers", "4"));
			TVT_FIGHT_TIME = TypeFormat.parseInt(p.getProperty("TvTFightTime", "10"));
			TVT_COUNTDOWN_TIME = TypeFormat.parseInt(p.getProperty("TvTCountDownTime", "30"));
			String[] TVTdoorsToClose = p.getProperty("TvTDoorsToClose", "").split(",");
			for(String door : TVTdoorsToClose)
				TVT_DOORS_TO_CLOSE.add(TypeFormat.parseInt(door));
			String[] TVTdoorsToOpen = p.getProperty("TvTDoorsToOpen", "").split(",");
			for(String door : TVTdoorsToOpen)
				TVT_DOORS_TO_OPEN.add(TypeFormat.parseInt(door));
			/** CTF */
			CTF_AUTO_MODE = TypeFormat.parseBoolean(p.getProperty("CTFAutoMode", "false"));
			CTF_TEAMS_NUM = TypeFormat.parseInt(p.getProperty("CTFTeamsNum", "2"));
			CTF_PLAYER_LEVEL_MIN = TypeFormat.parseInt(p.getProperty("CTFPlayerLevelMin", "1"));
			CTF_PLAYER_LEVEL_MAX = TypeFormat.parseInt(p.getProperty("CTFPlayerLevelMax", "80"));
			CTF_ALLOW_INTERFERENCE = TypeFormat.parseBoolean(p.getProperty("CTFAllowInterference", "false"));
			CTF_ALLOW_POTIONS = TypeFormat.parseBoolean(p.getProperty("CTFAllowPotions", "false"));
			CTF_ALLOW_SUMMON = TypeFormat.parseBoolean(p.getProperty("CTFAllowSummon", "false"));
			CTF_ALLOW_SCROLL = TypeFormat.parseBoolean(p.getProperty("CTFAllowScrolls", "false"));
			CTF_ON_START_REMOVE_ALL_EFFECTS = TypeFormat.parseBoolean(p.getProperty("CTFOnStartRemoveAllEffects", "true"));
			CTF_ON_START_UNSUMMON_PET = TypeFormat.parseBoolean(p.getProperty("CTFOnStartUnsummonPet", "true"));
			CTF_ALLOW_ENEMY_HEALING = TypeFormat.parseBoolean(p.getProperty("CTFAllowEnemyHealing", "false"));
			CTF_ALLOW_TEAM_CASTING = TypeFormat.parseBoolean(p.getProperty("CTFAllowTeamBuff", "false"));
			CTF_ALLOW_TEAM_ATTACKING = TypeFormat.parseBoolean(p.getProperty("CTFAllowTeamAttacking", "false"));
			CTF_JOIN_CURSED = TypeFormat.parseBoolean(p.getProperty("CTFJoinWithCursedWeapon", "true"));
			CTF_PRICE_NO_KILLS = TypeFormat.parseBoolean(p.getProperty("CTFPriceNoKills", "false"));
			CTF_AURA = TypeFormat.parseBoolean(p.getProperty("CTFAura", "true"));
			CTF_EVEN_TEAMS = p.getProperty("CTFEvenTeams", "SHUFFLE");
			CTF_REWARD = p.getProperty("CTFReward", "57:1000").split(";");
			CTF_REWARD_TOP = p.getProperty("CTFRewardTop", "57:1000").split(";");
			CTF_ANNOUNCE_REWARD = TypeFormat.parseBoolean(p.getProperty("CTFAnnounceReward", "false"));
			CTF_EVENT_INTERVAL = p.getProperty("CTFEventInterval", "20:00").split(",");
			CTF_NPC_LOC = p.getProperty("CTFNpcLoc", "147711,-55236,-2737").split(",");
			CTF_NPC_X = TypeFormat.parseInt(CTF_NPC_LOC[0]);
			CTF_NPC_Y = TypeFormat.parseInt(CTF_NPC_LOC[1]);
			CTF_NPC_Z = TypeFormat.parseInt(CTF_NPC_LOC[2]);
			CTF_NPC_LOC_NAME = p.getProperty("CTFNpcLocName", "Goddard Town");
			CTF_DEAD_LOC = p.getProperty("CTFDeadLoc", "147711,-55236,-2737").split(",");
			CTF_DEAD_X = TypeFormat.parseInt(CTF_DEAD_LOC[0]);
			CTF_DEAD_Y = TypeFormat.parseInt(CTF_DEAD_LOC[1]);
			CTF_DEAD_Z = TypeFormat.parseInt(CTF_DEAD_LOC[2]);
			CTF_RES_TIME = TypeFormat.parseInt(p.getProperty("CTFResTime", "1"));
			CTF_MIN_PLAYERS = TypeFormat.parseInt(p.getProperty("CTFMinPlayers", "4"));
			CTF_FIGHT_TIME = TypeFormat.parseInt(p.getProperty("CTFFightTime", "10"));
			CTF_COUNTDOWN_TIME = TypeFormat.parseInt(p.getProperty("CTFCountDownTime", "30"));
			String[] CTFdoorsToClose = p.getProperty("CTFDoorsToClose", "").split(",");
			for(String door : CTFdoorsToClose)
				CTF_DOORS_TO_CLOSE.add(TypeFormat.parseInt(door));
			String[] CTFdoorsToOpen = p.getProperty("CTFDoorsToOpen", "").split(",");
			for(String door : CTFdoorsToOpen)
				CTF_DOORS_TO_OPEN.add(TypeFormat.parseInt(door));
			/** BW */
			BW_AUTO_MODE = TypeFormat.parseBoolean(p.getProperty("BWAutoMode", "false"));
			BW_TEAMS_NUM = TypeFormat.parseInt(p.getProperty("BWTeamsNum", "2"));
			BW_PLAYER_LEVEL_MIN = TypeFormat.parseInt(p.getProperty("BWPlayerLevelMin", "1"));
			BW_PLAYER_LEVEL_MAX = TypeFormat.parseInt(p.getProperty("BWPlayerLevelMax", "80"));
			BW_ALLOW_INTERFERENCE = TypeFormat.parseBoolean(p.getProperty("BWAllowInterference", "false"));
			BW_ALLOW_POTIONS = TypeFormat.parseBoolean(p.getProperty("BWAllowPotions", "false"));
			BW_ALLOW_SUMMON = TypeFormat.parseBoolean(p.getProperty("BWAllowSummon", "false"));
			BW_ALLOW_SCROLL = TypeFormat.parseBoolean(p.getProperty("BWAllowScrolls", "false"));
			BW_ON_START_REMOVE_ALL_EFFECTS = TypeFormat.parseBoolean(p.getProperty("BWOnStartRemoveAllEffects", "true"));
			BW_ON_START_UNSUMMON_PET = TypeFormat.parseBoolean(p.getProperty("BWOnStartUnsummonPet", "true"));
			BW_ALLOW_ENEMY_HEALING = TypeFormat.parseBoolean(p.getProperty("BWAllowEnemyHealing", "false"));
			BW_ALLOW_TEAM_CASTING = TypeFormat.parseBoolean(p.getProperty("BWAllowTeamBuff", "false"));
			BW_ALLOW_TEAM_ATTACKING = TypeFormat.parseBoolean(p.getProperty("BWAllowTeamAttacking", "false"));
			BW_JOIN_CURSED = TypeFormat.parseBoolean(p.getProperty("BWJoinWithCursedWeapon", "true"));
			BW_PRICE_NO_KILLS = TypeFormat.parseBoolean(p.getProperty("BWPriceNoKills", "false"));
			BW_AURA = TypeFormat.parseBoolean(p.getProperty("BWAura", "true"));
			BW_EVEN_TEAMS = p.getProperty("BWEvenTeams", "SHUFFLE");
			BW_REWARD = p.getProperty("BWReward", "57:1000").split(";");
			BW_REWARD_TOP = p.getProperty("BWRewardTop", "57:1000").split(";");
			BW_ANNOUNCE_REWARD = TypeFormat.parseBoolean(p.getProperty("BWAnnounceReward", "false"));
			BW_EVENT_INTERVAL = p.getProperty("BWEventInterval", "20:00").split(",");
			BW_NPC_LOC = p.getProperty("BWNpcLoc", "147711,-55236,-2737").split(",");
			BW_NPC_X = TypeFormat.parseInt(BW_NPC_LOC[0]);
			BW_NPC_Y = TypeFormat.parseInt(BW_NPC_LOC[1]);
			BW_NPC_Z = TypeFormat.parseInt(BW_NPC_LOC[2]);
			BW_NPC_LOC_NAME = p.getProperty("BWNpcLocName", "Goddard Town");
			BW_DEAD_LOC = p.getProperty("BWDeadLoc", "147711,-55236,-2737").split(",");
			BW_DEAD_X = TypeFormat.parseInt(BW_DEAD_LOC[0]);
			BW_DEAD_Y = TypeFormat.parseInt(BW_DEAD_LOC[1]);
			BW_DEAD_Z = TypeFormat.parseInt(BW_DEAD_LOC[2]);
			BW_RES_TIME = TypeFormat.parseInt(p.getProperty("BWResTime", "1"));
			BW_MIN_PLAYERS = TypeFormat.parseInt(p.getProperty("BWMinPlayers", "4"));
			BW_FIGHT_TIME = TypeFormat.parseInt(p.getProperty("BWFightTime", "10"));
			BW_COUNTDOWN_TIME = TypeFormat.parseInt(p.getProperty("BWCountDownTime", "30"));
			String[] BWdoorsToClose = p.getProperty("BWDoorsToClose", "").split(",");
			for(String door : BWdoorsToClose)
				BW_DOORS_TO_CLOSE.add(TypeFormat.parseInt(door));
			String[] BWdoorsToOpen = p.getProperty("BWDoorsToOpen", "").split(",");
			for(String door : BWdoorsToOpen)
				BW_DOORS_TO_OPEN.add(TypeFormat.parseInt(door));
			/** DM */
			DM_AUTO_MODE = TypeFormat.parseBoolean(p.getProperty("DMAutoMode", "false"));
			DM_PLAYER_LEVEL_MIN = TypeFormat.parseInt(p.getProperty("DMPlayerLevelMin", "1"));
			DM_PLAYER_LEVEL_MAX = TypeFormat.parseInt(p.getProperty("DMPlayerLevelMax", "80"));
			DM_ALLOW_INTERFERENCE = TypeFormat.parseBoolean(p.getProperty("DMAllowInterference", "false"));
			DM_ALLOW_POTIONS = TypeFormat.parseBoolean(p.getProperty("DMAllowPotions", "false"));
			DM_ALLOW_SUMMON = TypeFormat.parseBoolean(p.getProperty("DMAllowSummon", "false"));
			DM_ALLOW_SCROLL = TypeFormat.parseBoolean(p.getProperty("DMAllowScrolls", "false"));
			DM_ON_START_REMOVE_ALL_EFFECTS = TypeFormat.parseBoolean(p.getProperty("DMOnStartRemoveAllEffects", "true"));
			DM_ON_START_UNSUMMON_PET = TypeFormat.parseBoolean(p.getProperty("DMOnStartUnsummonPet", "true"));
			DM_ALLOW_ENEMY_HEALING = TypeFormat.parseBoolean(p.getProperty("DMAllowEnemyHealing", "false"));
			DM_ALLOW_TEAM_CASTING = TypeFormat.parseBoolean(p.getProperty("DMAllowTeamBuff", "false"));
			DM_ALLOW_TEAM_ATTACKING = TypeFormat.parseBoolean(p.getProperty("DMAllowTeamAttacking", "false"));
			DM_JOIN_CURSED = TypeFormat.parseBoolean(p.getProperty("DMJoinWithCursedWeapon", "true"));
			DM_EVEN_TEAMS = "SHUFFLE"; //p.getProperty("DMEvenTeams", "SHUFFLE");
			DM_REWARD = p.getProperty("DMReward", "57:1000").split(";");
			DM_ANNOUNCE_REWARD = TypeFormat.parseBoolean(p.getProperty("DMAnnounceReward", "false"));
			DM_EVENT_INTERVAL = p.getProperty("DMEventInterval", "20:00").split(",");
			DM_NPC_LOC = p.getProperty("DMNpcLoc", "147711,-55236,-2737").split(",");
			DM_NPC_X = TypeFormat.parseInt(DM_NPC_LOC[0]);
			DM_NPC_Y = TypeFormat.parseInt(DM_NPC_LOC[1]);
			DM_NPC_Z = TypeFormat.parseInt(DM_NPC_LOC[2]);
			DM_START_LOC = p.getProperty("DMStartLoc", "-77408,-50656,-10728").split(",");
			DM_START_LOC_X = TypeFormat.parseInt(DM_START_LOC[0]);
			DM_START_LOC_Y = TypeFormat.parseInt(DM_START_LOC[1]);
			DM_START_LOC_Z = TypeFormat.parseInt(DM_START_LOC[2]);
			DM_NPC_LOC_NAME = p.getProperty("DMNpcLocName", "Goddard Town");
			DM_MIN_PLAYERS = TypeFormat.parseInt(p.getProperty("DMMinPlayers", "4"));
			DM_FIGHT_TIME = TypeFormat.parseInt(p.getProperty("DMFightTime", "10"));
			DM_COUNTDOWN_TIME = TypeFormat.parseInt(p.getProperty("DMCountDownTime", "30"));
			String[] DMdoorsToClose = p.getProperty("DMDoorsToClose", "").split(",");
			for(String door : DMdoorsToClose)
				DM_DOORS_TO_CLOSE.add(TypeFormat.parseInt(door));
			String[] DMdoorsToOpen = p.getProperty("DMDoorsToOpen", "").split(",");
			for(String door : DMdoorsToOpen)
				DM_DOORS_TO_OPEN.add(TypeFormat.parseInt(door));
			EVENT_SHOW_JOIN_DIALOG = TypeFormat.parseBoolean(p.getProperty("EventShowJoinDialog", "false"));
			ALLOW_DUALBOX_EVENT = TypeFormat.parseBoolean(p.getProperty("AllowDualBoxInEvent", "true"));
			/** BW */
			ENABLED_CHAOS_EVENT = Boolean.parseBoolean(p.getProperty("EnableChaosEvent", "False"));
			CHAOS_FIRST_WINNER_REWARD_ID = Integer.parseInt(p.getProperty("FirstWinnerRewardId", "57"));
			CHAOS_FIRST_WINNER_REWARD_QUANTITY = Integer.parseInt(p.getProperty("FirstWinnerRewardQuantity", "5000"));
			CHAOS_SECOND_WINNER_REWARD_ID = Integer.parseInt(p.getProperty("SecondWinnerRewardId", "57"));
			CHAOS_SECOND_WINNER_REWARD_QUANTITY = Integer.parseInt(p.getProperty("SecondWinnerRewardQuantity", "4000"));
			CHAOS_THIRD_WINNER_REWARD_ID = Integer.parseInt(p.getProperty("ThirdWinnerRewardId", "57"));
			CHAOS_THIRD_WINNER_REWARD_QUANTITY = Integer.parseInt(p.getProperty("ThirdWinnerRewardQuantity", "3000"));
			CHAOS_FOURTH_WINNER_REWARD_ID = Integer.parseInt(p.getProperty("FourthWinnerRewardId", "57"));
			CHAOS_FOURTH_WINNER_REWARD_QUANTITY = Integer.parseInt(p.getProperty("FourthWinnerRewardQuantity", "2000"));
			CHAOS_FIFTH_WINNER_REWARD_ID = Integer.parseInt(p.getProperty("FifthWinnerRewardId", "57"));
			CHAOS_FIFTH_WINNER_REWARD_QUANTITY = Integer.parseInt(p.getProperty("FifthWinnerRewardQuantity", "1000"));
			CHAOS_COLOR = Integer.decode("0x" + p.getProperty("ChaosColor", "000000"));
			CHAOS_SKILL_ID = Integer.parseInt(p.getProperty("ChaosSkillID", "7029"));
			CHAOS_SKILL_LVL = Integer.parseInt(p.getProperty("ChaosSkillLvL", "4"));

			p.clear();
		}
		catch(Exception e)
		{
			_log.warn("Failed to load " + ConfigFiles.EVENTS_INI);
		}
	}
