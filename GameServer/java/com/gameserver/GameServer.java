...
import com.Config;
import com.gameserver.ai.special.AILoader;
...
import com.gameserver.datatables.sql.CustomArmorSetsTable;
import com.gameserver.datatables.sql.HennaTreeTable;
...
import com.gameserver.datatables.xml.AugmentationData;
...
import com.gameserver.datatables.xml.HelperBuffTable;
...
import com.gameserver.datatables.xml.NpcWalkerRoutesTable;
import com.gameserver.datatables.xml.OpenLockDoors;
import com.gameserver.datatables.xml.RecipeTable;
import com.gameserver.datatables.xml.SkillSpellbookTable;
import com.gameserver.datatables.xml.SkillTreeTable;
import com.gameserver.datatables.xml.StaticObjects;
import com.gameserver.datatables.xml.SummonItemsData;
...
import com.gameserver.managers.CastleManorManager;
import com.gameserver.managers.ClanHallManager;
import com.gameserver.managers.CoupleManager;
import com.gameserver.managers.CrownManager;
import com.gameserver.managers.CursedWeaponsManager;
import com.gameserver.managers.DatatablesManager;
import com.gameserver.managers.DayNightSpawnManager;
import com.gameserver.managers.DimensionalRiftManager;
import com.gameserver.managers.DuelManager;
import com.gameserver.managers.FourSepulchersManager;
...
import com.gameserver.managers.RaidBossPointsManager;
import com.gameserver.managers.RaidBossSpawnManager;
import com.gameserver.managers.SiegeManager;
import com.gameserver.model.AutoChatHandler;
import com.gameserver.model.L2Manor;
...
import com.gameserver.model.entity.MonsterRace;
import com.gameserver.model.entity.clanhallsiege.BanditStrongholdSiege;
import com.gameserver.model.entity.clanhallsiege.DevastatedCastle;
import com.gameserver.model.entity.clanhallsiege.FortressOfResistance;
import com.gameserver.model.entity.clanhallsiege.WildBeastFarmSiege;
import com.gameserver.model.entity.market.Market;
...
import com.gameserver.model.spawn.AutoSpawn;
import com.gameserver.network.L2GameClient;
import com.gameserver.network.L2GamePacketHandler;
import com.gameserver.script.EventDroplist;
import com.gameserver.script.faenor.FaenorScriptEngine;
import com.gameserver.scripting.CompiledScriptCache;
import com.gameserver.scripting.L2ScriptEngineManager;
import com.gameserver.taskmanager.TaskManager;
import com.gameserver.thread.LoginServerThread;
import com.gameserver.thread.ThreadPoolManager;
import com.gameserver.thread.daemons.DeadlockDetector;
import com.gameserver.util.FloodProtector;
import com.gameserver.util.sql.SQLQueue;
import com.mmocore.SelectorConfig;
import com.mmocore.SelectorThread;
import com.util.Util;
import com.util.database.L2DatabaseFactory;
import com.util.protection.IPv4Filter;
import com.util.protection.nProtect;
import com.util.services.CreateFolders;
...
public class GameServer {
	...
	public static void main(String[] args) throws Exception {
		...
		sc.MAX_READ_PER_PASS = com.mmocore.Config.MMO_MAX_READ_PER_PASS;
		sc.MAX_SEND_PER_PASS = com.mmocore.Config.MMO_MAX_SEND_PER_PASS;
		sc.SLEEP_TIME = com.mmocore.Config.MMO_SELECTOR_SLEEP_TIME;
		sc.HELPER_BUFFER_COUNT = com.mmocore.Config.MMO_HELPER_BUFFER_COUNT;
