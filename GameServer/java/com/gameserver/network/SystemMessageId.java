...
public enum SystemMessageId {
	...
	/**
	 * ID: 32<br>
	 * Message: You are unable to engage in combat. Please go to the nearest restart
	 * point.
	 */
	...
	/**
	 * ID: 80<br>
	 * Message: Names must be between 1-16 characters, excluding spaces or special
	 * characters.
	 */
	...
	/**
	 * ID: 88<br>
	 * Message: Your protocol version is different, please restart your client and
	 * run a full check.
	 */
	...
	/**
	 * ID: 122<br>
	 * Message: You may no longer adjust items in the trade because the trade has
	 * been confirmed.
	 */
	MAY_NO_LONGER_ADJUST_ITEMS_BECAUSE_TRADE_CONFIRMED(122),
	...
	/**
	 * ID: 180<br>
	 * Message: You have $s1 day(s) left until deletion. Do you wish to cancel this
	 * action?
	 */
	...
	/**
	 * ID: 199<br>
	 * Message: You have recently been dismissed from a clan. You are not allowed to
	 * join another clan for 24-hours.
	 */
	...
	/**
	 * ID: 227<br>
	 * Message: Clan war has been refused because you did not respond to $s1 clan's
	 * war proclamation.
	 */
	...
	/**
	 * ID: 231<br>
	 * Message: "After a clan member is dismissed from a clan, the clan must wait at
	 * least a day before accepting a new member."
	 */
	YOU_MUST_WAIT_BEFORE_ACCEPTING_A_NEW_MEMBER(231),

	/**
	 * ID: 232<br>
	 * Message: "After leaving or having been dismissed from a clan, you must wait
	 * at least a day before joining another clan."
	 */
	...
	/**
	 * ID: 272<br>
	 * Message: A clan crest can only be registered when the clan's skill level is 3
	 * or above.
	 */
	...
	/**
	 * ID: 273<br>
	 * Message: A clan war can only be declared when a clan's skill level is 3 or
	 * above.
	 */
	...
	/**
	 * ID: 276<br>
	 * Message: You do not have the necessary materials or prerequisites to learn
	 * this skill.
	 */
	...
	/**
	 * ID: 287<br>
	 * Message: The opposing clan has started to engrave to monument!
	 */
	...
	/**
	 * ID: 294<br>
	 * Message: "Because your clan is not currently on the offensive in a Clan Hall
	 * siege war, it cannot summon its base camp."
	 */
	...
	/**
	 * ID: 337<br>
	 * Message: The soulshot you are attempting to use does not match the grade of
	...
	/**
	 * ID: 381<br>
	 * Message: The game client encountered an error and was unable to connect to
	 * the petition server.
	 */
	...
	/**
	 * ID: 418<br>
	 * Message: There is a significant difference between the item's price and its
	 * standard price. Please check again.
	 */
	PRICE_DIFFERECE(418),
	...
	/**
	 * ID: 428<br>
	 * Message: In accordance with company policy, your account has been suspended
	 * due to ...
	 */
	ILLEGAL_USE1(428),
	...
	/**
	 * ID: 446<br>
	 * Message: For more information, please visit the Support Center on the PlayNC
	 * website
	...
	/**
	 * ID: 456<br>
	 * Message: Lineage II game services may be used by individuals 15 years of age
	 * or older except for PvP servers,which may only be used by adults 18 years of
	 * age and older (Korea Only)
	 */
	LINAGE_MINIMUM_AGE(456),

	/**
	 * ID: 457<br>
	 * Message: Currently undergoing game server maintenance. Please log in again
	 * later.
	 */
	...
	/**
	 * ID: 541<br>
	 * Message: You may not delete a clan member. Withdraw from the clan first and
	 * try again.
	 */
	...
	/**
	 * ID: 562<br>
	 * Message: You may not crystallize this item. Your crystallization skill level
	 * is too low.
	 */
	...
	/**
	 * ID: 592<br>
	 * Message: Do you wish to dismiss your pet? Dismissing your pet will cause the
	 * pet necklace to disappear
	 */
	...
	/**
	 * ID: 607<br>
	 * Message: You do not have any further skills to learn. Come back when you have
	 * reached Level $s1.
	 */
	...
	/**
	 * ID: 634<br>
	 * Message: Your alliance leader has been slain. You have been defeated by the
	 * clan.
	 */
	...
	/**
	 * ID: 635<br>
	 * Message: The time limit for the clan war has been exceeded. War with the clan
	 * is over.
	 */
	...
	/**
	 * ID: 642<br>
	 * Message: You are already registered to the attacker side and must not cancel
	...
	/**
	 * ID: 643<br>
	 * Message: You are already registered to the defender side and must not cancel
	 * your registration before submitting your request
	 */
	 ...
	 */
	NO_AUTHORITY_TO_MODIFY_DEFENDER_LIST(646),

	/**
	 * ID: 647<br>
	 * Message: You do not have the authority to modify the siege time.
	 */
	NO_AUTHORITY_TO_MODIFY_SIEGE_TIME(647),
	...
	/**
	 * ID: 665<br>
	 * Message: of alliance is applying for alliance war. Do you want to accept the
	 * challenge?
	 */
	...
	/**
	 * ID: 667<br>
	 * Message: You are registering on the attacking side of the siege. Do you want
	 * to continue?
	 */
	...
	/**
	 * ID: 668<br>
	 * Message: You are registering on the defending side of the siege. Do you want
	 * to continue?
	 */
	...
	/**
	 * ID: 670<br>
	 * Message: You are refusing the registration of clan on the defending side. Do
	...
	/**
	 * ID: 671<br>
	 * Message: You are agreeing to the registration of clan on the defending side.
	...
	/**
	 * ID: 685<br>
	 * Message: You cannot apply for clan war with a clan that belongs to the same
	 * alliance
	 */
	...
	/**
	 * ID: 730<br>
	 * Message: - You have submitted your $s1th petition. - You may submit $s2 more
	 * petition(s) today.
	 */
	 ...
	 * the maximum that you can submit in one day. You cannot submit any more
	 * petitions.
	 */
	...
	/**
	 * ID: 751<br>
	 * Message: As there is a conflict in the siege relationship with a clan in the
	 * alliance, you cannot invite that clan to the alliance.
	 */
	...
	/**
	 * ID: 760<br>
	 * Message: $s1 cannot join the clan because one day has not yet passed since
	 * he/she left another clan.
	 */
	...
	/**
	 * ID: 763<br>
	 * Message: You failed at sending the package because you are too far from the
	 * warehouse.
	 */
	...
	/**
	 * ID: 769<br>
	 * Message: A hacking tool has been discovered. Please try again after closing
	...
	/**
	 * ID: 802<br>
	 * Message: Petitions are not being accepted at this time. You may submit your
	 * petition after a.m./p.m.
	 */
	...
	/**
	 * ID: 826<br>
	 * Message: First prize goes to the player in lane $s1. Second prize goes to the
	 * player in lane $s2.
	 */
	...
	/**
	 * ID: 836<br>
	 * Message: You have exceeded your inventory volume limit and cannot take this
	 * item.
	 */
	...
	/**
	 * ID: 897<br>
	 * Message:The ferry will leave for Talking Island Harbor after anchoring for
	 * ten minutes.
	 */
	...
	/**
	 * ID: 976<br>
	 * Message: The soul crystal broke because it was not able to endure the soul
	 * energy.
	 */
	...
	/**
	 * ID: 1039<br>
	 * Message: Items left at the clan hall warehouse can only be retrieved by the
	 * clan leader.
	 * Do you want to continue?
	 */
	...
	/**
	 * ID: 1044<br>
	 * Message: Monster race payout information is not available while tickets are
	 * being sold.
	 */
	...
	/**
	 * ID: 1050<br>
	 * Message: There are no communities in my clan. Clan communities are allowed
	 * for clans with skill levels of 2 and higher.
	 */
	...
	/**
	 * ID: 1053<br>
	 * Message: It is not possible to resurrect in battlefields where a siege war is
	 * taking place.
	 */
	...
	/**
	 * ID: 1078<br>
	 * Message: When a user's keyboard input exceeds a certain cumulative score a
	 * chat ban will be applied.
	 * This is done to discourage spamming. Please avoid posting the same message
	...
	/**
	 * ID: 1080<br>
	 * Message: Being permanent, are you sure you wish to use the facelift potion -
	 * Type A?
	 */
	...
	/**
	 * ID: 1081<br>
	 * Message: Being permanent, are you sure you wish to use the hair dye potion -
	 * Type A?
	 */
	...
	/**
	 * ID: 1119<br>
	 * Message: Quest was automatically canceled when you attempted to settle the
	 * accounts of
	...
	/**
	 * ID: 1123<br>
	 * Message: Weight and volume limit has been exceeded. That skill is currently
	 * unavailable.
	 */
	...
	/**
	 * ID: 1136<br>
	 * Message: Since there was an account that used this IP and attempted to log in
	 * illegally, this account
	 * is not allowed to connect to the game server for $s1 minutes. Please use
	 * another game server.
	 */
	...
	/**
	 * ID: 1143<br>
	 * Message: Since you do not have enough items to maintain the servitor's stay,
	 * the servitor will disappear.
	 */
	...
	/**
	 * ID: 1157<br>
	 * Message: Trying on state lasts for only 5 seconds. When a character's state
	 * changes, it can be cancelled.
	 */
	...
	/**
	 * ID: 1160<br>
	 * Message: The ferry from Talking Island will be arriving at Gludin Harbor in
	...
	/**
	 * ID: 1162<br>
	 * Message: The ferry from Giran Harbor will be arriving at Talking Island in
	...
	/**
	 * ID: 1166<br>
	 * Message: The ferry from Talking Island will be arriving at Giran Harbor in
	...
	/**
	 * ID: 1187<br>
	 * Message: If you forgotten your account information or password, please visit
	 * the Support Center
	...
	/**
	 * ID: 1189<br>
	 * Message: This temporary alliance of the Castle Attacker team is in effect. It
	 * will be dissolved when the Castle Lord is replaced.
	 */
	...
	/**
	 * ID: 1191<br>
	 * Message: The ferry from Gludin Harbor will be arriving at Talking Island in
	 * approximately 10 minutes.
	 */
	 ...
	 * Seal Validatio period until the time when a siege starts.
	 */
	...
	/**
	 * ID: 1215<br>
	 * Message: Seven Signs: The Revolutionaries of Dusk have obtained the Seal of
	 * Avarice.
	 */
	...
	/**
	 * ID: 1229<br>
	 * Message: No more messages may be sent at this time. Each account is allowed
	 * 10 messages per day.
	 */
	...
	/**
	 * ID: 1238<br>
	 * Message: Your temporary mailbox is full. No more mail can be stored; you have
	 * reached the 10 message limit.
	 */
	...
	/**
	 * ID: 1250<br>
	 * Message: Do you really want to surrender? If you surrender during an alliance
	 * war, your Exp will drop
	...
	/**
	 * ID: 1252<br>
	 * Message: Are you sure you want to surrender? Exp penalty will be the same as
	 * death.
	 */
	 ...
	 * ID: 1261<br>
	 * Message: Seven Signs: The quest event period has begun.
	 * Speak with a Priest of Dawn or Dusk Priestess if you wish to participate in
	 * the event.
	 */
	...
	/**
	 * ID: 1263<br>
	 * Message: Seven Signs: This is the seal validation period. A new quest event
	 * period begins next Monday.
	 */
	...
	/**
	 * ID: 1271<br>
	 * Message: Do you wish to participate? Until the next seal validation period,
	 * you are a member
	...
	/**
	 * ID: 1273<br>
	 * Message: You will participate in the Seven Signs as a member of the Lords of
	 * Dawn.
	 */
	...
	/**
	 * ID: 1310<br>
	 * Message: For full functionality, the latest version of MSN Messenger must be
	...
	/**
	 * ID: 1311<br>
	 * Message: Previous versions of MSN Messenger only provide the basic features
	 * for in-game MSN Messenger Chat.
	...
	/**
	 * ID: 1312<br>
	 * Message: The latest version of MSN Messenger may be obtained from the MSN web
	 * site
	...
	/**
	 * ID: 1314<br>
	 * Message: Please enter the passport ID of the person you wish to add to your
	 * contact list.
	 */
	...
	/**
	 * ID: 1315<br>
	 * Message: Deleting a contact will remove that contact from MSN Messenger as
	 * well.
	 * The contact can still check your online status and well not be blocked from
	...
	/**
	 * ID: 1319<br>
	 * Message: Please select the name of the contact you wish to change to another
	 * group.
	 */
	...
	/**
	 * ID: 1320<br>
	 * Message: After selecting the group you wish to move your contact to, press
	 * the OK button.
	 */
	...
	/**
	 * ID: 1325<br>
	 * Message: You've logged into another computer and have been logged out of the
	 * .NET
	...
	/**
	 * ID: 1329<br>
	 * Message: You are currently blocked from using the Private Store and Private
	 * Workshop.
	 */
	...
	/**
	 * ID: 1330<br>
	 * Message: You may not open a Private Store or Private Workshop for another $s1
	 * minute(s)
	 */
	...
	/**
	 * ID: 1331<br>
	 * Message: You are no longer blocked from using the Private Store and Private
	 * Workshop
	 */
	...
	/**
	 * ID: 1333<br>
	 * Message: The replay file is not accessible. Please verify that the replay.ini
	 * exists
	...
	/**
	 * ID: 1338<br>
	 * Message: You have exceeded the maximum amount that may be transferred at one
	 * time.
	 */
	...
	/**
	 * ID: 1339<br>
	 * Message: Once a macro is assigned to a shortcut, it cannot be run as a macro
	 * again.
	 */
	...
	/**
	 * ID: 1354<br>
	 * Message: You are not allowed to chat with a contact while chatting block is
	 * imposed.
	 */
	...
	/**
	 * ID: 1362<br>
	 * Message: Please select the contact you wish to delete. If you would like to
	 * delete a group,
	...
	/**
	 * ID: 1371<br>
	 * Message: It has been determined that you're not engaged in normal gameplay
	 * and a
	...
	/**
	 * ID: 1396<br>
	 * Message: The list of party rooms can only be viewed by a person who has not
	 * joined
	...
	/**
	 * ID: 1404<br>
	 * Message: The owner of the private manufacturing store has changed the price
	...
	/**
	 * ID: 1407<br>
	 * Message: You are using a computer that does not allow you to log in with two
	...
	/**
	 * ID: 1408<br>
	 * Message: Your prepaid remaining usage time is $s1 hours and $s2 minutes. You
	 * have $s3 paid reservations left.
	 */
	PREPAID_LEFT_S1_S2_S3(1408),

	/**
	 * ID: 1409<br>
	 * Message: Your prepaid usage time has expired. Your new prepaid reservation
	 * will be used. The remaining usage time is $s1 hours and $s2 minutes.
	 */
	...
	/**
	 * ID: 1414<br>
	 * Message: The width and length should be 100 or more grids and less than 5000
	 * grids respectively.
	 */
	...
	/**
	 * ID: 1437<br>
	 * Message: Players are no longer allowed to play dice. Dice can no longer be
	 * purchased from a village store.
	...
	/**
	 * ID: 1456<br>
	 * Message: You cannot fish while riding as a passenger of a boat - it's against
	 * the rules.
	 */
	...
	/**
	 * ID: 1484<br>
	 * Message: Are you sure this is the Hero weapon you wish to use? Kamael race
	 * cannot use this.
	 */
	...
	/**
	 * ID: 1500<br>
	 * Message: You cannot participate in the Grand Olympiad Games with a character
	 * in their subclass.
	 */
	...
	/**
	 * ID: 1503<br>
	 * Message: You have been registered in the Grand Olympiad Games waiting list
	 * for a class specific match.
	 */
	 ...
	 * ID: 1504<br>
	 * Message: You have been registered in the Grand Olympiad Games waiting list
	 * for a non-class specific match.
	 */
	...
	/**
	 * ID: 1506<br>
	 * Message: You are not currently registered on any Grand Olympiad Games waiting
	 * list.
	 */
	...
	/**
	 * ID: 1514<br>
	 * Message: You cannot resurrect the owner of a pet while their pet is being
	 * resurrected.
	 */
	...
	/**
	 * ID: 1515<br>
	 * Message: A pet cannot be resurrected while it's owner is in the process of
	 * resurrecting.
	 */
	...
	/**
	 * ID: 1519<br>
	 * Message: Your pet has been killed! Make sure you resurrect your pet within 20
	 * minutes
	...
	/**
	 * ID: 1523<br>
	 * Message: You should release your pet or servitor so that it does not fall off
	...
	/**
	 * ID: 1563<br>
	 * Message: The clan, $s1, cannot declare a Clan War because their clan is less
	 * than level three,
	...
	/**
	 * ID: 1570<br>
	 * Message: A declaration of war against more than 30 Clans can't be made at the
	 * same time
	 */
	...
	/**
	 * ID: 1574<br>
	 * Message: All is well. There are no clans that have declared war against your
	 * clan.
	 */
	...
	/**
	 * ID: 1575<br>
	 * Message: Command Channels can only be formed by a party leader who is also
	 * the leader of a level 5 clan.
	 */
	...
	/**
	 * ID: 1601<br>
	 * Message: Tomorrow's items will all be set to the same value as today's items.
	 * Do you wish to continue?
	 */
	...
	/**
	 * ID: 1604<br>
	 * Message: While dressed in formal wear, you can't use items that require all
	 * skills and casting operations.
	 */
	...
	/**
	 * ID: 1625<br>
	 * Message: Departure for Rune Harbor will take place after anchoring for ten
	 * minutes.
	 */
	...
	/**
	 * ID: 1638<br>
	 * Message: You cannot fish while using a recipe book, private manufacture or
	 * private store.
	 */
	...
	/**
	 * ID: 1650<br>
	 * Message: Due to high server traffic, your login attempt has failed. Please
	 * try again soon.
	 */
	...
	/**
	 * ID: 1665<br>
	 * Message: You've worn that fish out! It can't even pull the bobber under the
	 * water!
	 */
	 ...
	 * or more levels higher than your Fishing skill, a 50 damage penalty will be
	 * applied.
	 */
	...
	/**
	 * ID: 1673<br>
	 * Message: Your current record for this Grand Olympiad is $s1 match(es), $s2
	 * win(s) and $s3 defeat(s). You heave earned $s4 Olympiad Point(s).
	 */
	THE_PRESENT_RECORD_DURING_THE_CURRENT_OLYMPIAD_SESSION_IS_S1_WINS_S2_DEFEATS_YOU_HAVE_EARNED_S3_OLYMPIAD_POINTS(
			1673),
	...
	/**
	 * ID: 1677<br>
	 * Message: A cease-fire during a Clan War can not be called while members of
	 * your clan are engaged in battle.
	 */
	...
	/**
	 * ID: 1685<br>
	 * Message: You are unable to equip this item when your PK count is greater or
	 * equal to one.
	 */
	...
	/**
	 * ID: 1686<br>
	 * Message: Stones and mortar tumble to the earth - the castle wall has taken
	 * damage!
	 */
	...
	/**
	 * ID: 1687<br>
	 * Message: This area cannot be entered while mounted atop of a Wyvern. You will
	 * be dismounted from your Wyvern if you do not leave!
	 */
	...
	/**
	 * ID: 1690<br>
	 * Message: You have already joined the waiting list for a non-class specific
	 * match.
	 */
	...
	/**
	 * ID: 1691<br>
	 * Message: You can't join a Grand Olympiad Game match with that much stuff on
	 * you!
	...
	/**
	 * ID: 1693<br>
	 * Message: You may not observe a Grand Olympiad Games match while you are on
	 * the waiting list.
	 */
	...
	/**
	 * ID: 1694<br>
	 * Message: Only a clan leader that is a Noblesse can view the Siege War Status
	 * window during a siege war.
	 */
	...
	/**
	 * ID: 1697<br>
	 * Message: Your accumulated play time has reached Fatigue level, so you will
	 * receive experience or item drops at only 50 percent [...]
	 */
	ACCUMULATED_PLAY_TIME_WARNING1(1697),

	/**
	 * ID: 1698<br>
	 * Message: Your accumulated play time has reached Ill-health level, so you will
	 * no longer gain experience or item drops. [...}
	 */
	...
	/**
	 * ID: 1705<br>
	 * Message: PC Bang Points acquisition period. Points acquisition period left
	 * $s1 hour.
	 */
	...
	/**
	 * ID: 1713<br>
	 * Message: The games may be delayed due to an insufficient number of players
	 * waiting.
	 */
	GAMES_DELAYED(1713),
	...
	/**
	 * ID: 1728<br>
	 * Message: The recipient of your invitation did not accept the party matching
	 * invitation.
	 */
	...
	/**
	 * ID: 1737<br>
	 * Message: Your clan has not established a Clan Academy but is eligible to do
	 * so.
	 */
	...
	/**
	 * ID: 1743<br>
	 * Message: To open a Clan Academy, the leader of a Level 5 clan or above must
	 * pay XX Proofs of Blood or a certain amount of adena.
	 */
	OPEN_ACADEMY_CONDITIONS(1743),

	/**
	 * ID: 1744<br>
	 * Message: There was no response to your invitation to join the Clan Academy,
	 * so the invitation has been rescinded.
	 */
	...
	/**
	 * ID: 1747<br>
	 * Message: $s1 has sent you an invitation to join the Clan Academy belonging to
	 * the $s2 clan. Do you accept?
	 */
	...
	/**
	 * ID: 1752<br>
	 * Message: Since the clan has received a graduate of the Clan Academy, it has
	 * earned $s1 points towards its reputation score.
	 */
	MEMBER_GRADUATED_EARNED_S1_REPU(1752),

	/**
	 * ID: 1753<br>
	 * Message: The clan leader has decreed that that particular privilege cannot be
	 * granted to a Clan Academy member.
	 */
	...
	/**
	 * ID: 1768<br>
	 * Message: $s1 has invited you to join the Clan Academy of $s2 clan. Would you
	 * like to join?
	 */
	...
	/**
	 * ID: 1770<br>
	 * Message: The clan's reputation score has dropped below 0. The clan may face
	 * certain penalties as a result.
	 */
	...
	/**
	 * ID: 1777<br>
	 * Message: You have successfully completed a clan quest. $s1 points have been
	 * added to your
	 * clan's reputation score.
	 */
	...
	/**
	 * ID: 1778<br>
	 * Message: An opposing clan has captured your clan's contested clan hall. $s1
	 * points have
	...
	/**
	 * ID: 1779<br>
	 * Message: After losing the contested clan hall, 300 points have been deducted
	 * from your
	 * clan's reputation score.
	 */
	 ...
	 * your clan's reputation score and added to your opponent's clan reputation
	 * score.
	 */
	...
	/**
	 * ID: 1790<br>
	 * Message: The conditions necessary to increase the clan's level have not been
	 * met.
	 */
	...
	/**
	 * ID: 1803<br>
	 * Message: The request to participate in the game cannot be made starting from
	...
	/**
	 * ID: 1825<br>
	 * Message: You have failed in your attempt to register for the clan hall war.
	 * Please try again.
	 */
	...
	/**
	 * ID: 1826<br>
	 * Message: In $s1 minute(s), the game will begin. All players must hurry and
	 * move to the left side of the clan hall's arena.
	 */
	...
	/**
	 * ID: 1831<br>
	 * Message: $s1 does not meet the conditions of the party room. Please update
	 * the waiting list.
	 */
	...
	/**
	 * ID: 1837<br>
	 * Message: $s1 has sent you an invitation to join the $s3 Royal Guard under the
	 * $s2 clan. Would you like to join?
	 */
	...
	/**
	 * ID: 1848<br>
	 * Message: Because of the size of fish caught, you will be registered in the
	 * ranking
	 */
	...
	/**
	 * ID: 1856<br>
	 * Message: Since your opponent is now the owner of $s1, the Olympiad has been
	 * cancelled.
	 */
	...
	/**
	 * ID: 1862<br>
	 * Message: Clan skills will now be activated since the clan's reputation score
	 * is 0 or higher.
	 */
	...
	/**
	 * ID: 1869<br>
	 * Message: $s1 has granted the Command Channel's master party the privilege of
	 * item looting.
	 */
	...
	/**
	 * ID: 1873<br>
	 * Message: There are $s1 hour(s) and $s2 minute(s) left in the fixed use time
	 * for this PC Cafe.
	 */
	...
	/**
	 * ID: 1890<br>
	 * Message: Since you have already used this coupon, you may not use this serial
	 * number.
	 */
	...
	/**
	 * ID: 1898<br>
	 * Message: $s1 is currently trading or operating a private store and cannot be
	 * summoned.
	 */
	...
	/**
	 * ID: 1903<br>
	 * Message: Those of you who have requested NCOTP should run NCOTP by using your
	 * cell phone [...]
	 */
	NCOTP(1903),
	...
	/**
	 * ID: 1904<br>
	 * Message: A sub-class may not be created or changed while a servitor or pet is
	 * summoned.
	 */
	...
	/**
	 * ID: 1920<br>
	 * Message: Your account is currently inactive because you have not logged into
	 * the game
	...
	/**
	 * ID: 1929<br>
	 * Message: $s1 has accepted your challenge to a duel. The duel will begin in a
	 * few moments.
	 */
	...
	/**
	 * ID: 1930<br>
	 * Message: You have accepted $s1's challenge to a duel. The duel will begin in
	 * a few moments.
	 */
	...
	/**
	 * ID: 1937<br>
	 * Message: Since the person you challenged is not currently in a party, they
	 * cannot duel against your party.
	 */
	...
	/**
	 * ID: 1942<br>
	 * Message: The opposing party is currently unable to accept a challenge to a
	 * duel.
	 */
	...
	/**
	 * ID: 1944<br>
	 * Message: In a moment, you will be transported to the site where the duel will
	 * take place.
	 */
	...
	/**
	 * ID: 1972<br>
	 * Message: You cannot augment items while a private store or private workshop
	 * is in operation.
	 */
	...
	/**
	 * ID: 2014<br>
	 * Message: You cannot proceed because the manor cannot accept any more crops.
	 * All crops
	...
	/**
	 * ID: 2016<br>
	 * Message: A skill is ready to be used again but its re-use counter time has
	 * increased.
	 */
	...
	/**
	 * ID: 2017<br>
	 * Message: $s1 cannot duel because $s1 is currently engaged in a private store
	 * or manufacture.
	 */
	...
	/**
	 * ID: 2027<br>
	 * Message: $s1 cannot duel because $s1 is currently riding a boat, wyvern, or
	 * strider.
	 */
	...
	AUTO_FARM_ACTIVATED(2032),
	AUTO_FARM_DESACTIVATED(2033),
	ACTIVATE_RESPECT_HUNT(2034),
	DESACTIVATE_RESPECT_HUNT(2035),
	ACTIVATE_SUMMON_ACTACK(2036),
	DESACTIVATE_SUMMON_ACTACK(2037);
