package com.gameserver.communitybbs.Manager;
...
import com.gameserver.model.L2TeleportLocation;
...
public class TeleBBSManager extends BaseBBSManager {
	...
	public boolean checkAllowed(L2PcInstance activeChar) {
		...
		else if (Config.COMMUNITY_GATEKEEPER_EXCLUDE_ON.contains("ATTACK")
		...
		else if (Config.COMMUNITY_GATEKEEPER_EXCLUDE_ON.contains("SIEGE")
				&& activeChar.isInsideZone(L2Character.ZONE_SIEGE))
			msg = "You can't use Community Gatekeeper when you on siege!";
		else if (Config.COMMUNITY_GATEKEEPER_EXCLUDE_ON.contains("OLYMPIAD") && (activeChar.isInOlympiadMode()
