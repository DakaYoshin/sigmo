package com.gameserver.communitybbs.module;
...
public class ServerStats
{
	...
	{ 
		String stats = "<br>Average Weapon Enchant: <font color=\"LEVEL\">" + getAverageWeaponEnchant() + "</font>" +
		               ...
		               "<br>" +
		               "<br>Average pDef: <font color=\"LEVEL\">" + getStat("pdef") + "</font>" +
		               ...
		               "<br>Average casting speed: <font color=\"LEVEL\">" + getStat("castspeed") + "</font>" +
		               "<br>Average melee speed: <font color=\"LEVEL\">" + getStat("attackspeed") + "</font>" +
