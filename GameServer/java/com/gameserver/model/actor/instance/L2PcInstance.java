...
public final class L2PcInstance extends L2Playable
{
	...
	public void onAction(L2PcInstance player)
	{
		...
		{
			if (((getEventName().equals("TVT") || player.getEventName().equals("TVT")) && !Config.TVT_ALLOW_INTERFERENCE)
				|| ((getEventName().equals("CTF") || player.getEventName().equals("CTF")) && !Config.CTF_ALLOW_INTERFERENCE)
				|| ((getEventName().equals("BW") || player.getEventName().equals("BW")) && !Config.BW_ALLOW_INTERFERENCE)
				|| ((getEventName().equals("DM") || player.getEventName().equals("DM")) && !Config.DM_ALLOW_INTERFERENCE))
			{
		...
		else
		{
			...
			else
			{
				if(isAutoAttackable(player) || player.isInEvent())
				{
					...
					{
						if (((getEventName().equals("TVT") || player.getEventName().equals("TVT")) && !Config.TVT_ALLOW_TEAM_ATTACKING)
							|| ((getEventName().equals("CTF") || player.getEventName().equals("CTF")) && !Config.CTF_ALLOW_TEAM_ATTACKING)
							|| ((getEventName().equals("BW") || player.getEventName().equals("BW")) && !Config.BW_ALLOW_TEAM_ATTACKING)
							|| ((getEventName().equals("DM") || player.getEventName().equals("DM")) && !Config.DM_ALLOW_TEAM_ATTACKING))
						{
							if (Config.GEODATA > 0)
							{
	...
	public boolean isAutoAttackable(L2Character attacker)
	{
		...
		if (isFightingInEvent())
		{
			if (attacker instanceof L2PcInstance && ((L2PcInstance) attacker) != null && isInSameEvent(((L2PcInstance) attacker)) && !isInSameTeam(((L2PcInstance) attacker)))
				return true;
		}
	...
	public void useMagic(L2Skill skill, boolean forceUse, boolean dontMove)
	{
		...
		if (isFightingInEvent() && target instanceof L2PcInstance)
		{
			...
			if (skill.isSkillTypeOffensive() && skill.getTargetType() == SkillTargetType.TARGET_ONE && isInSameTeam(p_target))
			{
