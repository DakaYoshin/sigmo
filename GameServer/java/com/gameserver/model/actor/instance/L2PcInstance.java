...
import com.gameserver.ai.L2CharacterAI;
import com.gameserver.ai.L2PlayerAI;
...
import com.gameserver.datatables.AccessLevel;
import com.gameserver.datatables.ClanLeaderSkillTable;
import com.gameserver.datatables.GmListTable;
import com.gameserver.datatables.HeroSkillTable;
import com.gameserver.datatables.NobleSkillTable;
...
import com.gameserver.datatables.xml.AccessLevels;
import com.gameserver.datatables.xml.CharTemplateTable;
import com.gameserver.datatables.xml.FishTable;
...
import com.gameserver.datatables.xml.RecipeTable;
...
import com.gameserver.managers.CoupleManager;
import com.gameserver.managers.CursedWeaponsManager;
import com.gameserver.managers.DimensionalRiftManager;
import com.gameserver.managers.DuelManager;
import com.gameserver.managers.FunEventsManager;
import com.gameserver.managers.GrandBossManager;
import com.gameserver.managers.ItemsOnGroundManager;
import com.gameserver.managers.QuestManager;
import com.gameserver.managers.SiegeManager;
import com.gameserver.model.BlockList;
import com.gameserver.model.FishData;
import com.gameserver.model.L2Clan;
import com.gameserver.model.L2ClanMember;
import com.gameserver.model.L2Effect;
import com.gameserver.model.L2Fishing;
import com.gameserver.model.L2Macro;
import com.gameserver.model.L2ManufactureList;
import com.gameserver.model.L2Object;
import com.gameserver.model.L2Party;
import com.gameserver.model.L2Radar;
import com.gameserver.model.L2RecipeList;
import com.gameserver.model.L2Request;
import com.gameserver.model.L2ShortCut;
import com.gameserver.model.L2Skill;
import com.gameserver.model.L2Skill.SkillTargetType;
import com.gameserver.model.L2SkillLearn;
import com.gameserver.model.L2World;
import com.gameserver.model.Location;
import com.gameserver.model.MacroList;
import com.gameserver.model.PartyMatchRoom;
import com.gameserver.model.PartyMatchRoomList;
import com.gameserver.model.PartyMatchWaitingList;
import com.gameserver.model.ShortCuts;
import com.gameserver.model.TradeList;
import com.gameserver.model.actor.L2Attackable;
...
import com.gameserver.model.actor.appearance.PcAppearance;
import com.gameserver.model.actor.knownlist.PcKnownList;
import com.gameserver.model.actor.stat.PcStat;
import com.gameserver.model.actor.status.PcStatus;
import com.gameserver.model.base.ClassId;
import com.gameserver.model.base.ClassLevel;
import com.gameserver.model.base.Experience;
import com.gameserver.model.base.PlayerClass;
import com.gameserver.model.base.Race;
import com.gameserver.model.base.SubClass;
import com.gameserver.model.entity.Announcements;
import com.gameserver.model.entity.ChaosEvent;
import com.gameserver.model.entity.Duel;
import com.gameserver.model.entity.clanhallsiege.DevastatedCastle;
import com.gameserver.model.entity.olympiad.Olympiad;
import com.gameserver.model.entity.sevensigns.SevenSigns;
import com.gameserver.model.entity.sevensigns.SevenSignsFestival;
import com.gameserver.model.entity.siege.Castle;
import com.gameserver.model.entity.siege.Siege;
import com.gameserver.model.extender.BaseExtender.EventType;
import com.gameserver.model.itemcontainer.Inventory;
import com.gameserver.model.itemcontainer.ItemContainer;
import com.gameserver.model.itemcontainer.PcFreight;
import com.gameserver.model.itemcontainer.PcInventory;
import com.gameserver.model.itemcontainer.PcWarehouse;
import com.gameserver.model.itemcontainer.PetInventory;
import com.gameserver.model.quest.Quest;
import com.gameserver.model.quest.QuestState;
import com.gameserver.model.zone.type.L2BossZone;
...
import com.gameserver.network.serverpackets.ChangeWaitType;
import com.gameserver.network.serverpackets.CharInfo;
import com.gameserver.network.serverpackets.ConfirmDlg;
import com.gameserver.network.serverpackets.CreatureSay;
import com.gameserver.network.serverpackets.EtcStatusUpdate;
import com.gameserver.network.serverpackets.ExAutoSoulShot;
import com.gameserver.network.serverpackets.ExDuelUpdateUserInfo;
import com.gameserver.network.serverpackets.ExFishingEnd;
import com.gameserver.network.serverpackets.ExFishingStart;
import com.gameserver.network.serverpackets.ExOlympiadMode;
import com.gameserver.network.serverpackets.ExOlympiadUserInfo;
import com.gameserver.network.serverpackets.ExSetCompassZoneCode;
import com.gameserver.network.serverpackets.ExShowScreenMessage;
import com.gameserver.network.serverpackets.ExStorageMaxCount;
import com.gameserver.network.serverpackets.FriendList;
import com.gameserver.network.serverpackets.HennaInfo;
import com.gameserver.network.serverpackets.InventoryUpdate;
import com.gameserver.network.serverpackets.ItemList;
import com.gameserver.network.serverpackets.L2GameServerPacket;
import com.gameserver.network.serverpackets.LeaveWorld;
...
import com.gameserver.network.serverpackets.ObservationMode;
import com.gameserver.network.serverpackets.ObservationReturn;
import com.gameserver.network.serverpackets.PartySmallWindowUpdate;
import com.gameserver.network.serverpackets.PetInventoryUpdate;
import com.gameserver.network.serverpackets.PledgeShowInfoUpdate;
import com.gameserver.network.serverpackets.PledgeShowMemberListDelete;
import com.gameserver.network.serverpackets.PledgeShowMemberListUpdate;
import com.gameserver.network.serverpackets.PrivateStoreListBuy;
import com.gameserver.network.serverpackets.PrivateStoreListSell;
import com.gameserver.network.serverpackets.QuestList;
import com.gameserver.network.serverpackets.RecipeShopSellList;
import com.gameserver.network.serverpackets.RelationChanged;
import com.gameserver.network.serverpackets.Ride;
import com.gameserver.network.serverpackets.SendTradeDone;
import com.gameserver.network.serverpackets.ServerClose;
import com.gameserver.network.serverpackets.SetupGauge;
import com.gameserver.network.serverpackets.ShortBuffStatusUpdate;
import com.gameserver.network.serverpackets.ShortCutInit;
import com.gameserver.network.serverpackets.SkillCoolTime;
import com.gameserver.network.serverpackets.SkillList;
import com.gameserver.network.serverpackets.Snoop;
import com.gameserver.network.serverpackets.SocialAction;
import com.gameserver.network.serverpackets.StatusUpdate;
import com.gameserver.network.serverpackets.StopMove;
import com.gameserver.network.serverpackets.SystemMessage;
import com.gameserver.network.serverpackets.TargetSelected;
import com.gameserver.network.serverpackets.TargetUnselected;
import com.gameserver.network.serverpackets.TitleUpdate;
import com.gameserver.network.serverpackets.TradePressOtherOk;
import com.gameserver.network.serverpackets.TradePressOwnOk;
import com.gameserver.network.serverpackets.TradeStart;
import com.gameserver.network.serverpackets.UserInfo;
import com.gameserver.network.serverpackets.ValidateLocation;
import com.gameserver.skills.Formulas;
import com.gameserver.skills.Stats;
import com.gameserver.skills.effects.EffectCharge;
import com.gameserver.skills.l2skills.L2SkillSummon;
import com.gameserver.templates.chars.L2PcTemplate;
import com.gameserver.templates.item.L2Armor;
import com.gameserver.templates.item.L2ArmorType;
import com.gameserver.templates.item.L2EtcItem;
import com.gameserver.templates.item.L2EtcItemType;
import com.gameserver.templates.item.L2Henna;
import com.gameserver.templates.item.L2Item;
import com.gameserver.templates.item.L2Weapon;
import com.gameserver.templates.item.L2WeaponType;
...
public final class L2PcInstance extends L2Playable {
	...
	public void refreshMasteryPenality() {
		...
		if (_heavy_mastery == false && _light_mastery == false && _light_mastery == false) { // not completed 1st class
																								// transfer or not
																								// acquired yet the
																								// mastery skills
	...
	public void checkIfWeaponIsAllowed() {
		...
		for (L2Effect currenteffect : getAllEffects()) {
			...
			if (currenteffect.getSkill().isToggle() && Config.INTERRUPT_TOGGLE_SKILL_EFFECT) {
				currenteffect.exit();
			} else if (!effectSkill.isOffensive() && !(effectSkill.getTargetType() == SkillTargetType.TARGET_PARTY
	...
	public void checkSSMatch(L2ItemInstance equipped, L2ItemInstance unequipped) {
		...
		if (unequipped.getItem().getType2() == L2Item.TYPE2_WEAPON && (equipped == null ? true
				: equipped.getItem().getCrystalType() != unequipped.getItem().getCrystalType())) {
			for (L2ItemInstance ss : getInventory().getItems()) {
				...
				if ((_itemId >= 2509 && _itemId <= 2514 || _itemId >= 3947 && _itemId <= 3952
						|| _itemId <= 1804 && _itemId >= 1808 || _itemId == 5789 || _itemId == 5790 || _itemId == 1835)
	 ...
	 * @param abortAttack If true, the current attack will be aborted in order to
	 *                    equip the item.
	 */
	public void useEquippableItem(L2ItemInstance item, boolean abortAttack) {
		...
		if (isEquipped) {
			...
			if (item.isEquipped()) {
				...
				// Consume mana - will start a task if required; returns if item is not a shadow
				// item
	...
	public void addAdena(String process, int count, L2Object reference, boolean sendMessage) {
		if (count > 0) {
			if (_inventory.getAdena() == Integer.MAX_VALUE) {
				sendMessage(
						"You have reached the maximum amount of adena, please spend or deposit the adena so you may continue obtaining adena.");
				return;
	...
	public void addAncientAdena(String process, int count, L2Object reference, boolean sendMessage) {
		if (sendMessage) {
			sendPacket(new SystemMessage(SystemMessageId.EARNED_S2_S1_S).addItemName(PcInventory.ANCIENT_ADENA_ID)
					.addNumber(count));
		}
	...
	public boolean reduceAncientAdena(String process, int count, L2Object reference, boolean sendMessage) {
		...
		if (count > 0) {
			...
			if (sendMessage) {
				sendPacket(new SystemMessage(SystemMessageId.S2_S1_DISAPPEARED).addNumber(count)
						.addItemName(PcInventory.ANCIENT_ADENA_ID));
			}
			...
			if (sendMessage) {
				if (item.getCount() > 1) {
					if (item.isStackable() && !Config.MULTIPLE_ITEM_DROP) {
						...
						sendPacket(new SystemMessage(SystemMessageId.YOU_PICKED_UP_S1_S2).addItemName(item.getItemId())
								.addNumber(item.getCount()));
					}
				} else if (item.getEnchantLevel() > 0) {
					sendPacket(new SystemMessage(SystemMessageId.YOU_PICKED_UP_A_S1_S2)
							.addNumber(item.getEnchantLevel()).addItemName(item.getItemId()));
				} else {
					sendPacket(new SystemMessage(SystemMessageId.YOU_PICKED_UP_S1).addItemName(item.getItemId()));
				}
			}
	...
	public void addItem(String process, int itemId, int count, L2Object reference, boolean sendMessage) {
		if (count > 0) {
			...
			if (ditem == null)
				return;
			if (sendMessage && (!isCastingNow() && ditem.getItemType() == L2EtcItemType.HERB
					|| ditem.getItemType() != L2EtcItemType.HERB)) {
				if (count > 1) {
					if (process.equalsIgnoreCase("sweep") || process.equalsIgnoreCase("Quest")) {
						sendPacket(
								new SystemMessage(SystemMessageId.EARNED_S2_S1_S).addItemName(itemId).addNumber(count));
					} else {
						sendPacket(new SystemMessage(SystemMessageId.YOU_PICKED_UP_S1_S2).addItemName(itemId)
								.addNumber(count));
					}
				} else {
					if (process.equalsIgnoreCase("sweep") || process.equalsIgnoreCase("Quest")) {
	...
	public boolean destroyItem(String process, L2ItemInstance item, int count, L2Object reference,
			boolean sendMessage) {
		...
		if (sendMessage) {
			sendPacket(new SystemMessage(SystemMessageId.S2_S1_DISAPPEARED).addNumber(oldCount)
	...
	public boolean destroyItemWithoutTrace(String process, int objectId, int count, L2Object reference,
			boolean sendMessage) {
		L2ItemInstance item = _inventory.getItemByObjectId(objectId);
	...
	public L2ItemInstance dropItem(String process, int objectId, int count, int x, int y, int z, L2Object reference,
			boolean sendMessage, boolean protectItem) {
		...
		if (Config.AUTODESTROY_ITEM_AFTER > 0 && Config.DESTROY_DROPPED_PLAYER_ITEM
	...
	public void setProtection(boolean protect) {
		...
		_protectEndTime = protect ? GameTimeController.getGameTicks() + proTime * GameTimeController.TICKS_PER_SECOND
				: 0;
	}

	public void setRecentFakeDeath(boolean protect) {
		_recentFakeDeathEndTime = protect
				? GameTimeController.getGameTicks()
						+ Config.PLAYER_FAKEDEATH_UP_PROTECTION * GameTimeController.TICKS_PER_SECOND
				: 0;
	}
	...
	public void onAction(L2PcInstance player) {
		...
		if ((isFightingInEvent() || player.isFightingInEvent()) && !isInSameEvent(player) && !player.isGM()) {
			if (((getEventName().equals("TVT") || player.getEventName().equals("TVT"))
					&& !Config.TVT_ALLOW_INTERFERENCE)
					|| ((getEventName().equals("CTF") || player.getEventName().equals("CTF"))
							&& !Config.CTF_ALLOW_INTERFERENCE)
					|| ((getEventName().equals("BW") || player.getEventName().equals("BW"))
							&& !Config.BW_ALLOW_INTERFERENCE)
					|| ((getEventName().equals("DM") || player.getEventName().equals("DM"))
							&& !Config.DM_ALLOW_INTERFERENCE)) {
		...
		if (player.getTarget() != this) {
			...
			if (getPrivateStoreType() != 0) {
				...
				if (isAutoAttackable(player) || player.isInEvent()) {
					if (isFightingInEvent() && isInSameTeam(player)) {
						if (((getEventName().equals("TVT") || player.getEventName().equals("TVT"))
								&& !Config.TVT_ALLOW_TEAM_ATTACKING)
								|| ((getEventName().equals("CTF") || player.getEventName().equals("CTF"))
										&& !Config.CTF_ALLOW_TEAM_ATTACKING)
								|| ((getEventName().equals("BW") || player.getEventName().equals("BW"))
										&& !Config.BW_ALLOW_TEAM_ATTACKING)
								|| ((getEventName().equals("DM") || player.getEventName().equals("DM"))
										&& !Config.DM_ALLOW_TEAM_ATTACKING)) {
							if (Config.GEODATA > 0) {
					...
					if (player.getLevel() < Config.PLAYER_PROTECTION_LEVEL
							|| getLevel() < Config.PLAYER_PROTECTION_LEVEL) {
						player.sendMessage("You can't hit a player that is lower level from You. Target's level: "
								+ String.valueOf(Config.PLAYER_PROTECTION_LEVEL));
						player.sendPacket(ActionFailed.STATIC_PACKET);
		...
		if (gm.isGM()) {
			if (this != gm.getTarget()) {
				...
				IAdminCommandHandler ach = AdminCommandHandler.getInstance()
						.getAdminCommandHandler("admin_character_info");
				if (ach != null) {
		...
		synchronized (target) {
			...
			if (target.getOwnerId() != 0 && target.getOwnerId() != getObjectId()
				...
				if (target.getItemId() == 57) {
					sendPacket(
							new SystemMessage(SystemMessageId.FAILED_TO_PICKUP_S1_ADENA).addNumber(target.getCount()));
				} else if (target.getCount() > 1) {
					sendPacket(new SystemMessage(SystemMessageId.FAILED_TO_PICKUP_S2_S1_S)
							.addItemName(target.getItemId()).addNumber(target.getCount()));
				} else {
					sendPacket(new SystemMessage(SystemMessageId.FAILED_TO_PICKUP_S1).addItemName(target.getItemId()));
				}
	...
	public void setTarget(L2Object newTarget) {
		...
		if (newTarget != null) {
			if (!(newTarget instanceof L2PcInstance) || !isInParty() || !((L2PcInstance) newTarget).isInParty()
					|| getParty().getPartyLeaderOID() != ((L2PcInstance) newTarget).getParty().getPartyLeaderOID()) {
			...
			if (isCursedWeaponEquiped()) {
				...
				if (pk == null || !pk.isCursedWeaponEquiped()) {
					...
					if (!(isInsideZone(ZONE_PVP) && !isInsideZone(ZONE_SIEGE))) {
						...
						if (isKillerPc && ((L2PcInstance) killer).getClan() != null && getClan() != null
								&& !isAcademyMember() && !((L2PcInstance) killer).isAcademyMember()
								&& _clan.isAtWarWith(((L2PcInstance) killer).getClanId())
								&& ((L2PcInstance) killer).getClan().isAtWarWith(_clan.getClanId())) {
							if (getClan().getReputationScore() > 0) {
								((L2PcInstance) killer).getClan().setReputationScore(
										((L2PcInstance) killer).getClan().getReputationScore() + 1, true);
							}
						...
						if (Config.ALT_GAME_DELEVEL) {
							if (getSkillLevel(L2Skill.SKILL_LUCKY) < 0 || getStat().getLevel() > 9) {
								deathPenalty((pk != null && getClan() != null && pk.getClan() != null
										&& pk.getClan().isAtWarWith(getClanId())), charmOfCourage);
							}
						} else {
							onDieUpdateKarma();
						}
	...
	private void onDieDropItem(L2Character killer) {
		...
		if (getKarma() <= 0 && killer instanceof L2PcInstance && ((L2PcInstance) killer).getClan() != null
				&& getClan() != null && ((L2PcInstance) killer).getClan().isAtWarWith(getClanId())) {
			return;
		}
		...
		if (!isInsideZone(ZONE_PVP) && (!isGM() || Config.KARMA_DROP_GM)) {
			...
			while (dropPercent > 0 && Rnd.get(100) < dropPercent && dropCount < dropLimit) {
				...
				for (L2ItemInstance itemDrop : getInventory().getItems()) {
					if (itemDrop.isAugmented() || itemDrop.isShadowItem() || itemDrop.getItemId() == 57
							|| itemDrop.getItem().getType2() == L2Item.TYPE2_QUEST
							|| nonDroppableList.contains(itemDrop.getItemId())
							|| nonDroppableListPet.contains(itemDrop.getItemId())
					...
					if (Rnd.get(100) < itemDropPercent) {
						...
						if (isKarmaDrop) {
							_log.warn(getName() + " has karma and dropped id = " + itemDrop.getItemId() + ", count = "
									+ itemDrop.getCount());
						} else {
							_log.warn(getName() + " dropped id = " + itemDrop.getItemId() + ", count = "
									+ itemDrop.getCount());
						}
	...
	public void onKillUpdatePvPKarma(L2Character target) {
		...
		if (checkIfPvP(target) && targetPlayer.getPvpFlag() != 0
			...
			if (target instanceof L2PcInstance && Config.ANNOUNCE_PVP_KILL) // Announces a PvP kill
				Announcements.getInstance()
						.announceToPlayers("Player " + this.getName() + " hunted Player " + target.getName());
			return;
		} else {
				...
				if (getClan().isAtWarWith(targetPlayer.getClanId())
					...
					if (targetPlayer.getClan().isAtWarWith(getClanId())
						...
						if (target instanceof L2PcInstance && Config.ANNOUNCE_PVP_KILL) {
							Announcements.getInstance()
									.announceToAll("Player " + getName() + " hunted Player " + target.getName());
						} else if (target instanceof L2PcInstance && Config.ANNOUNCE_ALL_KILL) {
							Announcements.getInstance()
									.announceToAll("Player " + getName() + " killed Player " + target.getName());
						}
						return;
					}
				}
			...
			if (targetPlayer.getKarma() > 0) {
				...
				if (target instanceof L2PcInstance && Config.ANNOUNCE_PK_KILL) // Announces a Pk kill
					Announcements.getInstance().announceToPlayers(
							"Player " + this.getName() + " has assassinated Player " + target.getName());
			}
		...
		if (target instanceof L2PcInstance && Config.ANNOUNCE_ALL_KILL) // Announces all kill
			Announcements.getInstance()
					.announceToPlayers("Player " + this.getName() + " killed Player " + target.getName());
	...
	public void deathPenalty(boolean atwar, boolean charmOfCourage) {
		...
		if (!atEvent) {
			if (lvl < Experience.MAX_LEVEL) {
				lostExp = Math
						.round((getStat().getExpForLevel(lvl + 1) - getStat().getExpForLevel(lvl)) * percentLost / 100);
			} else {
				lostExp = Math.round((getStat().getExpForLevel(Experience.MAX_LEVEL)
						- getStat().getExpForLevel(Experience.MAX_LEVEL - 1)) * percentLost / 100);
			}
		}
	...
	protected void reduceArrowCount() {
		L2ItemInstance arrows = getInventory().destroyItem("Consume",
				getInventory().getPaperdollObjectId(Inventory.PAPERDOLL_LHAND), 1, this, null);
	...
	protected boolean checkAndEquipArrows() {
		if (getInventory().getPaperdollItem(Inventory.PAPERDOLL_LHAND) == null
				&& getInventory().getPaperdollItem(Inventory.PAPERDOLL_RHAND).getItemType() == L2WeaponType.BOW) {
		...
		if (wpn != null) {
			...
			if (unequiped.length > 0) {
				if (unequiped[0].getEnchantLevel() > 0) {
					sendPacket(new SystemMessage(SystemMessageId.EQUIPMENT_S1_S2_REMOVED)
							.addNumber(unequiped[0].getEnchantLevel()).addItemName(unequiped[0].getItemId()));
				} else {
		...
		if (level == AccessLevels._masterAccessLevelNum) {
			...
			if (accessLevel == null) {
				if (level < 0) {
					...
					_log.warn("Tried to set unregistered access level " + level + " to character " + getName()
	...
	public void updateIsIn7sDungeonStatus() {
		...
		try {
			con = L2DatabaseFactory.getInstance().getConnection();
			statement = con
					.prepareStatement("UPDATE characters SET isIn7sDungeon = ?, lastAccess = ? WHERE obj_id = ?");
	...
	private boolean createDb() {
		...
		try {
			...
			statement = con.prepareStatement("INSERT INTO characters "
					...
					+ "base_class, newbie, nobless, power_grade, last_recom_date, name_color, title_color, haswhacc, whaccid, whaccpwd, aio, aio_end, vip, vip_end) "
					+ " VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
		...
		if (_forumMail == null) {
			...
			if (_forumMail == null) {
				ForumsBBSManager.getInstance().createNewForum(getName(),
						ForumsBBSManager.getInstance().getForumByName("MailRoot"), Forum.MAIL, Forum.OWNERONLY,
						getObjectId());
				setMail(ForumsBBSManager.getInstance().getForumByName("MailRoot").getChildByName(getName()));
			}
		}
	...
	public Forum getMemo() {
		if (_forumMemo == null) {
			...
			if (_forumMemo == null) {
				ForumsBBSManager.getInstance().createNewForum(_accountName,
						ForumsBBSManager.getInstance().getForumByName("MemoRoot"), Forum.MEMO, Forum.OWNERONLY,
						getObjectId());
				setMemo(ForumsBBSManager.getInstance().getForumByName("MemoRoot").getChildByName(_accountName));
			}
		}
	...
	private void storeRecipeBook() {
		...
		try {
			...
			for (L2RecipeList recipe : recipes) {
				statement = con
						.prepareStatement("INSERT INTO character_recipebook (char_id, id, type) VALUES (?, ?, 0)");
				statement.setInt(1, getObjectId());
			...
			for (L2RecipeList recipe : recipes) {
				statement = con
						.prepareStatement("INSERT INTO character_recipebook (char_id, id, type) VALUES (?, ?, 1)");
				statement.setInt(1, getObjectId());
				statement.setInt(2, recipe.getId());
				statement.execute();
				statement.close();
	...
	private void restoreRecipeBook() {
		...
		try {
			...
			PreparedStatement statement = con
					.prepareStatement("SELECT id, type FROM character_recipebook WHERE char_id = ?");
			statement.setInt(1, getObjectId());
			ResultSet rset = statement.executeQuery();
		...
		try {
			...
			for (L2Effect effect : getAllEffects()) {
				if (effect != null && !effect.isHerbEffect() && effect.getInUse() && !effect.getSkill().isToggle()
						&& effect.getSkill().getSkillType() != L2SkillType.FORCE_BUFF
						&& effect.getSkill().getId() != 426 && effect.getSkill().getId() != 427) {
	...
	public void checkAllowedSkills() {
		...
		if (!isGM()) {
			...
			for (L2Skill skill : getAllSkills()) {
				...
				if (isCursedWeaponEquiped() && skillid == CursedWeaponsManager.getInstance()
						.getCursedWeapon(_cursedWeaponEquipedId).getSkillId()) {
					foundskill = true;
				}
				...
				if (!foundskill) {
					...
					_log.warn("Cheater! - Character " + getName() + " of Account " + getAccountName() + " got skill "
							+ skill.getName() + " removed!" + IllegalPlayerAction.PUNISH_KICK);
				}
			}
			skillTree = null;
		}
	...
	public boolean removeHenna(int slot) {
		...
		sendPacket(new SystemMessage(SystemMessageId.EARNED_S2_S1_S).addItemName(henna.getItemIdDye())
				.addNumber(henna.getAmountDyeRequire() / 2));
	...
	public boolean isAutoAttackable(L2Character attacker) {
		...
		if (isFightingInEvent()) {
			if (attacker instanceof L2PcInstance && ((L2PcInstance) attacker) != null
					&& isInSameEvent(((L2PcInstance) attacker)) && !isInSameTeam(((L2PcInstance) attacker)))
				return true;
		}
		...
		if (attacker instanceof L2PcInstance) {
			...
			if (getClan() != null) {
				...
				if (getClan() != null && ((L2PcInstance) attacker).getClan() != null
						&& getClan().isAtWarWith(((L2PcInstance) attacker).getClanId()) && getWantsPeace() == 0
						&& ((L2PcInstance) attacker).getWantsPeace() == 0 && !isAcademyMember()) {
					return true;
				}
			}
			...
			if (getClan() != null) {
				...
				return siege != null && siege.checkIsAttacker(getClan())
						|| DevastatedCastle.getInstance().getIsInProgress();
			}
		}
	...
	public void useMagic(L2Skill skill, boolean forceUse, boolean dontMove) {
		...
		if (_disabledSkills != null && _disabledSkills.contains(skill_id)) {
			sendPacket(
					new SystemMessage(SystemMessageId.S1_PREPARED_FOR_REUSE).addSkillName(skill_id, skill.getLevel()));
			return;
		}

		if ((skill_id == 13 || skill_id == 299 || skill_id == 448)
		...
		if (isInDuel()) {
			if (!(target instanceof L2PcInstance && ((L2PcInstance) target).getDuelId() == getDuelId())
					&& !(target instanceof L2SummonInstance
							&& ((L2Summon) target).getOwner().getDuelId() == getDuelId())) {
		...
		if (isFightingInEvent() && target instanceof L2PcInstance) {
			...
			if (skill.isSkillTypeOffensive() && skill.getTargetType() == SkillTargetType.TARGET_ONE
					&& isInSameTeam(p_target)) {
				if ((getEventName().equals("TVT") && !Config.TVT_ALLOW_TEAM_CASTING)
						|| (getEventName().equals("CTF") && !Config.CTF_ALLOW_TEAM_CASTING)
						|| (getEventName().equals("BW") && !Config.BW_ALLOW_TEAM_CASTING)
						|| (getEventName().equals("DM") && !Config.DM_ALLOW_TEAM_CASTING)) {
		...
		if (isFightingInEvent()) {
			if (skill.getSkillType() == L2SkillType.SUMMON) {
				if ((getEventName().equals("TVT") && !Config.TVT_ALLOW_SUMMON)
						|| (getEventName().equals("CTF") && !Config.CTF_ALLOW_SUMMON)
						|| (getEventName().equals("BW") && !Config.BW_ALLOW_SUMMON)
						|| (getEventName().equals("DM") && !Config.DM_ALLOW_SUMMON)) {
					sendMessage("Can't summon on battle ground.");
					return;
				}
			}
		}
		...
		if (skill.getItemConsume() > 0) {
			...
			if (requiredItems == null || requiredItems.getCount() < skill.getItemConsume()) {
				if (sklType == L2SkillType.SUMMON) {
					sendPacket(new SystemMessage(SystemMessageId.SUMMONING_SERVITOR_COSTS_S2_S1)
							.addItemName(skill.getItemConsumeId()).addNumber(skill.getItemConsume()));
					return;
				} else {
					sendPacket(new SystemMessage(SystemMessageId.NOT_ENOUGH_ITEMS));
					return;
		...
		if (skill.getNumCharges() > 0 && skill.getSkillType() != L2SkillType.CHARGE
				&& skill.getSkillType() != L2SkillType.CHARGEDAM && skill.getSkillType() != L2SkillType.CHARGE_EFFECT
				&& skill.getSkillType() != L2SkillType.PDAM) {
		...
		if (effect != null && effect.numCharges >= skill.getNumCharges()
				&& skill.getSkillType() == L2SkillType.CHARGE) {
		...
		if (skill.isOffensive()) {
			...
			if (peace
					&& (skill.getId() != 3261 // Like L2OFF you can use cupid bow skills on peace zone
							&& skill.getId() != 3260
							&& skill.getId() != 3262 && sklTargetType != SkillTargetType.TARGET_AURA)) // Like L2OFF
																										// people can
																										// use
																										// TARGET_AURE
																										// skills on
			...
			if (dontMove) {
				if (sklTargetType == SkillTargetType.TARGET_GROUND) {
					if (!isInsideRadius(getCurrentSkillWorldPosition().getX(), getCurrentSkillWorldPosition().getY(),
							getCurrentSkillWorldPosition().getZ(),
							skill.getCastRange() + getTemplate().getCollisionRadius(), false, false)) {
						sendPacket(SystemMessageId.TARGET_TOO_FAR);
						sendPacket(ActionFailed.STATIC_PACKET);
						return;
					}
				} else if (skill.getCastRange() > 0 && !isInsideRadius(target,
		...
		if (sklTargetType == SkillTargetType.TARGET_GROUND) {
			...
			if (worldPosition == null) {
				...
				sendPacket(ActionFailed.STATIC_PACKET);
				return;
			} else if (!isInsideRadius(getCurrentSkillWorldPosition().getX(), getCurrentSkillWorldPosition().getY(),
					getCurrentSkillWorldPosition().getZ(), skill.getCastRange(), false, true)) {
		...
		if (sklType == L2SkillType.SIEGEFLAG && !SiegeFlag.checkIfOkToPlaceFlag(this, false)) {
			...
			abortCast();
			return;
		} else if (sklType == L2SkillType.STRSIEGEASSAULT
	...
	/**
	 * Check if the requested casting is a Pc->Pc skill cast and if it's a valid pvp
	 * condition
	 * 
	...
	public boolean checkPvpSkill(L2Object target, L2Skill skill, boolean srcIsSummon) {
		...
		if (target != null && target != this && target instanceof L2PcInstance
				&& !(isInDuel() && ((L2PcInstance) target).getDuelId() == getDuelId()) && !isInsideZone(ZONE_PVP)
				&& !((L2PcInstance) target).isInsideZone(ZONE_PVP)) {
	...
	public boolean checkLandingState() {
		if (isInsideZone(ZONE_NOLANDING)) {
			return true;
				...
				&& !(getClan() != null && CastleManager.getInstance().getCastle(this) == CastleManager.getInstance()
						.getCastleByOwner(getClan()) && this == getClan().getLeader().getPlayerInstance())) {
			return true;
		}
	...
	public void rechargeAutoSoulShot(boolean physical, boolean magic, boolean summon) {
		...
		for (int itemId : _activeSoulShots.values()) {
			...
			if (item != null) {
				if (magic) {
					if (!summon) {
						if (itemId == 2509 || itemId == 2510 || itemId == 2511 || itemId == 2512 || itemId == 2513
								|| itemId == 2514 || itemId == 3947 || itemId == 3948 || itemId == 3949
				...
				if (physical) {
					if (!summon) {
						if (itemId == 1463 || itemId == 1464 || itemId == 1465 || itemId == 1466 || itemId == 1467
								|| itemId == 1835 || itemId == 5789) {
							handler = ItemHandler.getInstance().getItemHandler(itemId);
	...
	public void leaveObserverMode() {
		if (!_observerMode) {
			...
			Util.handleIllegalPlayerAction(L2PcInstance.this,
					"Warning!! Character " + L2PcInstance.this.getName() + " tried to cheat in observer mode.",
	...
	public boolean getCoupon(int coupon) {
		return (_hasCoupon == 1 || _hasCoupon == 3) && coupon == 0
				|| (_hasCoupon == 2 || _hasCoupon == 3) && coupon == 1;
	}
	...
	public SystemMessage getNoDuelReason() {
		SystemMessage sm = (new SystemMessage(SystemMessageId.THERE_IS_NO_OPPONENT_TO_RECEIVE_YOUR_CHALLENGE_FOR_A_DUEL)
				.addString(getName()));
		return sm;
	}
	...
	public boolean canDuel() {
		...
		if (isMounted() || isInBoat()) {
			sendPacket(new SystemMessage(
					SystemMessageId.S1_CANNOT_DUEL_BECAUSE_S1_IS_CURRENTLY_RIDING_A_BOAT_WYVERN_OR_STRIDER));
			return false;
		}
	...
	public void startWarnUserTakeBreak() {
		if (_taskWarnUserTakeBreak == null) {
			_taskWarnUserTakeBreak = ThreadPoolManager.getInstance().scheduleGeneralAtFixedRate(new WarnUserTakeBreak(),
					7200000, 7200000);
		}
	}
	...
	public void onPlayerEnter() {
		...
		if (SevenSigns.getInstance().isSealValidationPeriod() || SevenSigns.getInstance().isCompResultsPeriod()) {
			if (!isGM() && isIn7sDungeon() && SevenSigns.getInstance().getPlayerCabal(this) != SevenSigns.getInstance()
	...
	public void reviveRequest(L2PcInstance Reviver, L2Skill skill, boolean Pet) {
		...
		if (Pet && getPet() != null && getPet().isDead() || !Pet && isDead()) {
			...
			if (isPhoenixBlessed()) {
				...
				_revivePower = Formulas.getInstance().calculateSkillResurrectRestorePercent(skill.getPower(),
						Reviver.getWIT());
			} else {
				_revivePower = 0;
			}
	...
	public final void onTeleported() {
		...
		if (getTrainedBeast() != null) {
			...
			getTrainedBeast().teleToLocation(getPosition().getX() + Rnd.get(-100, 100),
					getPosition().getY() + Rnd.get(-100, 100), getPosition().getZ(), false);
	...
	public final boolean updatePosition(int gameTicks) {
		...
		if (distFraction > 1) {
			...
			super.setXYZ(getX() + (int) (dx * distFraction + 0.5), getY() + (int) (dy * distFraction + 0.5),
					getZ() + (int) (dz * distFraction + 0.5));
		}
	...
	public static boolean checkSummonerStatus(L2PcInstance summonerChar) {
		...
		if (summonerChar.isInsideZone(L2Character.ZONE_NOSUMMONFRIEND) || summonerChar.isFlying()
				|| summonerChar.isMounted()) {
			summonerChar.sendPacket(
	...
	public void deleteMe() {
		...
		try {
			FunEventsManager.getInstance().notifyPlayerLogout(this);
		} catch (Exception e) {
			_log.error("", e);
		}
		try {
	...
	public void StartLookingForFishTask() {
		if (!isDead() && _taskforfish == null) {
			...
			_taskforfish = ThreadPoolManager.getInstance()
					.scheduleEffectAtFixedRate(new LookingForFishTask(_fish.getWaitTime(), _fish.getFishGuts(),
							_fish.getType(), isNoob, isUpperGrade), 10000, checkDelay);
		}
	}
	...
	public void setCurrentPetSkill(L2Skill currentSkill, boolean ctrlPressed, boolean shiftPressed) {
		...
		if (_log.isDebugEnabled())
			_log.info("Setting current skill: " + currentSkill.getName() + " (ID: " + currentSkill.getId() + ") for "
					+ getName() + ".");
	 ...
	 * 
	 * _jailTask = ThreadPoolManager.getInstance().scheduleGeneral(new
	 * JailTask(this), _jailTimer);
	 ...
	 * {
	 * htmlMsg.
	 * setHtml("<html><body>You have been put in jail by an admin.</body></html>");
	 * }
	 * sendPacket(htmlMsg);
	 * htmlMsg = null;
	 * 
	 ...
	 * {
	 * htmlMsg.
	 * setHtml("<html><body>You are free for now, respect server rules!</body></html>"
	 * );
	 * }
	 * sendPacket(htmlMsg);
	 * htmlMsg = null;
	 ...
	 * _jailTask = ThreadPoolManager.getInstance().scheduleGeneral(new
	 * JailTask(this), _jailTimer);
	 * sendMessage("You are still in jail for " + Math.round(_jailTimer / 60000) +
	 * " minutes.");
	 * }
	 * 
	...
	public void calculateDeathPenaltyBuffLevel(L2Character killer) {
		if ((getKarma() > 0 || Rnd.get(1, 100) <= Config.DEATH_PENALTY_CHANCE) && !(killer instanceof L2PcInstance)
				&& !isGM()
				&& !(getCharmOfLuck() && !isPhoenixBlessed()
	...
	public void ClanSkills() {
		...
		sendMessage((new StringBuilder()).append("Admin give to you ").append(Config.REPUTATION_QUANTITY)
				.append(" Reputation Points.").toString());
	...
	public void reduceDeathPenaltyBuffLevel() {
		...
		if (getDeathPenaltyBuffLevel() > 0) {
			addSkill(SkillTable.getInstance().getInfo(5076, getDeathPenaltyBuffLevel()), false);
			sendPacket(new EtcStatusUpdate(this));
			sendPacket(new SystemMessage(SystemMessageId.DEATH_PENALTY_LEVEL_S1_ADDED)
					.addNumber(getDeathPenaltyBuffLevel()));
		} else {
			sendPacket(new EtcStatusUpdate(this));
	 ...
	 * {
	 * _chatBanned = true;
	 * _chatBanTask = ThreadPoolManager.getInstance().scheduleGeneral(new
	 * ChatBanTask(this), _chatBanTimer);
	 * sendPacket(new EtcStatusUpdate(this));
	 * }
	 * }
	 * 
	 ...
	 * _chatBanTask = ThreadPoolManager.getInstance().scheduleGeneral(new
	 * ChatBanTask(this), _chatBanTimer);
	 * sendMessage("You are chat banned for " + (_chatBanTimer / 60 / 1000) +
	 * " minutes.");
	 * sendPacket(new EtcStatusUpdate(this));
	 * }
	 * }
	...
	public void showTeleportHtml() {
		...
		text.append("<br><br>");
		text.append("<table width=\"85%\"><tr><td>Your party leader, " + getParty().getLeader().getName()
				+ ", requested a group teleport to raidboss. You have 30 seconds from this popup to teleport, or the teleport windows will close</td></tr></table><br>");
	...
	private void updatePunishState() {
		if (getPunishLevel() != PunishLevel.NONE) {
			...
			if (_punishTimer > 0) {
				_punishTask = ThreadPoolManager.getInstance().scheduleGeneral(new PunishTask(this), _punishTimer);
				sendMessage(
						"You are still " + getPunishLevel().string() + " for " + (_punishTimer / 60000) + " minutes.");
			}
	...
	public void setVar(String name, String value) {
		...
		try {
			...
			statement = con.prepareStatement(
					"REPLACE INTO character_variables (obj_id, type, name, value) VALUES (?, ?, ?, ?)");
			statement.setInt(1, getObjectId());
	...
	public void unsetVar(String name) {
		...
		if (user_variables.remove(name) != null) {
			...
			try {
				...
				statement = con.prepareStatement(
						"DELETE FROM `character_variables` WHERE `obj_id`= ? AND `type`= ? AND `name`= ? LIMIT 1");
				statement.setInt(1, getObjectId());
				statement.setString(2, "var");
				statement.setString(3, name);
				statement.execute();
