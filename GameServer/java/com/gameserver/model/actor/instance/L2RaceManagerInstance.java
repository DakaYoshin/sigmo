...
import com.gameserver.model.actor.knownlist.RaceManagerKnownList;
...
import com.gameserver.network.serverpackets.MonRaceInfo;
...
public class L2RaceManagerInstance extends L2Npc
{
	...
	public void showBuyTicket(L2PcInstance player, int val)
	{
		...
		else
		{
			...
			player.setRace(0, 0);
			player.setRace(1, 0);
			player.sendPacket(new SystemMessage(SystemMessageId.ACQUIRED).addNumber(_raceNumber).addItemName(4443));
