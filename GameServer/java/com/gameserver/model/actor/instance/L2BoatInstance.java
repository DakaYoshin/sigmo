...
import com.gameserver.model.actor.knownlist.BoatKnownList;
...
import com.gameserver.network.serverpackets.OnVehicleCheckLocation;
import com.gameserver.network.serverpackets.PlaySound;
import com.gameserver.network.serverpackets.VehicleDeparture;
import com.gameserver.network.serverpackets.VehicleInfo;
...
public class L2BoatInstance extends L2Character {
	...
	private class L2BoatTrajet {
		...
		public L2BoatTrajet(int pIdWaypoint1, int pIdWTicket1, int pNtx1, int pNty1, int pNtz1, String pNpc1,
				String pSysmess10_1, String pSysmess5_1, String pSysmess1_1, String pSysmess0_1, String pSysmessb_1,
				String pBoatname) {
		...
		public int state(int state, L2BoatInstance _boat) {
			if (state < max) {
				...
				_boat.getPosition()
						.setHeading((int) (Math.atan2(-sin, -cos) * 10430.378350470452724949566316381) + 32768);
	...
	public void setTrajet1(int idWaypoint1, int idWTicket1, int ntx1, int nty1, int ntz1, String idnpc1,
			String sysmess10_1, String sysmess5_1, String sysmess1_1, String sysmess0_1, String sysmessb_1) {
		_t1 = new L2BoatTrajet(idWaypoint1, idWTicket1, ntx1, nty1, ntz1, idnpc1, sysmess10_1, sysmess5_1, sysmess1_1,
				sysmess0_1, sysmessb_1, _name);
	}

	public void setTrajet2(int idWaypoint1, int idWTicket1, int ntx1, int nty1, int ntz1, String idnpc1,
			String sysmess10_1, String sysmess5_1, String sysmess1_1, String sysmess0_1, String sysmessb_1) {
		_t2 = new L2BoatTrajet(idWaypoint1, idWTicket1, ntx1, nty1, ntz1, idnpc1, sysmess10_1, sysmess5_1, sysmess1_1,
				sysmess0_1, sysmessb_1, _name);
	}
