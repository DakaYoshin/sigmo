...
import static com.gameserver.ai.CtrlIntention.AI_INTENTION_ATTACK;
import static com.gameserver.ai.CtrlIntention.AI_INTENTION_FOLLOW;
...
import com.gameserver.ai.L2AttackableAI;
...
import com.gameserver.datatables.xml.MapRegionTable.TeleportWhereType;
...
import com.gameserver.geo.util.Door;
...
import com.gameserver.managers.RaidBossSpawnManager;
import com.gameserver.managers.TownManager;
import com.gameserver.model.ChanceSkillList;
import com.gameserver.model.CharEffectList;
import com.gameserver.model.ForceBuff;
...
import com.gameserver.model.actor.instance.L2BoatInstance;
import com.gameserver.model.actor.instance.L2ControlTowerInstance;
import com.gameserver.model.actor.instance.L2DoorInstance;
import com.gameserver.model.actor.instance.L2EffectPointInstance;
import com.gameserver.model.actor.instance.L2FlameTowerInstance;
import com.gameserver.model.actor.instance.L2FriendlyMobInstance;
import com.gameserver.model.actor.instance.L2GrandBossInstance;
import com.gameserver.model.actor.instance.L2GuardInstance;
import com.gameserver.model.actor.instance.L2ItemInstance;
import com.gameserver.model.actor.instance.L2MinionInstance;
import com.gameserver.model.actor.instance.L2MonsterInstance;
import com.gameserver.model.actor.instance.L2NpcInstance;
import com.gameserver.model.actor.instance.L2NpcWalkerInstance;
import com.gameserver.model.actor.instance.L2PcInstance;
import com.gameserver.model.actor.instance.L2PcInstance.SkillDat;
import com.gameserver.model.actor.instance.L2PetInstance;
import com.gameserver.model.actor.instance.L2RaidBossInstance;
import com.gameserver.model.actor.instance.L2RiftInvaderInstance;
import com.gameserver.model.actor.instance.L2SiegeFlagInstance;
import com.gameserver.model.actor.instance.L2SiegeGuardInstance;
import com.gameserver.model.actor.instance.L2SiegeSummonInstance;
import com.gameserver.model.actor.instance.L2SummonInstance;
import com.gameserver.model.actor.knownlist.CharKnownList;
import com.gameserver.model.actor.knownlist.ObjectKnownList.KnownListAsynchronousUpdateTask;
import com.gameserver.model.actor.position.L2CharPosition;
import com.gameserver.model.actor.stat.CharStat;
import com.gameserver.model.actor.status.CharStatus;
...
import com.gameserver.network.Disconnection;
import com.gameserver.network.SystemMessageId;
import com.gameserver.network.serverpackets.ActionFailed;
import com.gameserver.network.serverpackets.Attack;
import com.gameserver.network.serverpackets.BeginRotation;
import com.gameserver.network.serverpackets.ChangeMoveType;
import com.gameserver.network.serverpackets.ChangeWaitType;
import com.gameserver.network.serverpackets.CharInfo;
import com.gameserver.network.serverpackets.CharMoveToLocation;
import com.gameserver.network.serverpackets.ExOlympiadSpelledInfo;
...
import com.gameserver.network.serverpackets.MagicEffectIcons;
import com.gameserver.network.serverpackets.MagicSkillCanceld;
import com.gameserver.network.serverpackets.MagicSkillLaunched;
import com.gameserver.network.serverpackets.MagicSkillUser;
import com.gameserver.network.serverpackets.NpcInfo;
import com.gameserver.network.serverpackets.PartySpelled;
import com.gameserver.network.serverpackets.PetInfo;
import com.gameserver.network.serverpackets.RelationChanged;
import com.gameserver.network.serverpackets.Revive;
...
import com.gameserver.network.serverpackets.TeleportToLocation;
import com.gameserver.network.serverpackets.ValidateLocationInVehicle;
import com.gameserver.skills.Calculator;
import com.gameserver.skills.Formulas;
import com.gameserver.skills.Stats;
import com.gameserver.skills.effects.EffectCharge;
import com.gameserver.skills.funcs.Func;
import com.gameserver.taskmanager.AttackStanceTaskManager;
import com.gameserver.templates.StatsSet;
import com.gameserver.templates.chars.L2CharTemplate;
...
public abstract class L2Character extends L2Object {
	...
	public L2Character(int objectId, L2CharTemplate template) {
		...
		if (Config.ALT_INVUL_NPC) {
			if (!(this instanceof L2Attackable) && !(this instanceof L2PcInstance) && !(this instanceof L2GuardInstance)
					&& !(this instanceof L2SiegeGuardInstance) && !(this instanceof L2ControlTowerInstance)
					&& !(this instanceof L2FlameTowerInstance) && !(this instanceof L2DoorInstance)
	...
	public void onTeleported() {
		...
		if (this instanceof L2Summon) {
			((L2Summon) this).getOwner().sendPacket(
		...
		if (getPet() != null) {
			...
			getPet().teleToLocation(getPosition().getX() + Rnd.get(-100, 100),
					...
					if (mov instanceof CharInfo && this instanceof L2PcInstance) {
						{
							...
							if (getKnownList().getKnownRelations().get(player.getObjectId()) != null
								...
								player.sendPacket(new RelationChanged((L2PcInstance) this, relation,
										player.isAutoAttackable(this)));
							}
						}
					}
	...
	public void teleToLocation(Location loc, boolean allowRandomOffset) {
		...
		if (this instanceof L2PcInstance
				&& DimensionalRiftManager.getInstance().checkIfInRiftZone(getX(), getY(), getZ(), true)) {
	...
	protected void doAttack(L2Character target) {
		...
		if (this instanceof L2PcInstance) {
			...
			if (target instanceof L2PcInstance) {
				if (((L2PcInstance) target).isCursedWeaponEquiped()
						&& ((L2PcInstance) this).getLevel() <= Config.MAX_LEVEL_NEWBIE) {
					((L2PcInstance) this).sendMessage("Can't attack a cursed player when under level 21.");
					sendPacket(ActionFailed.STATIC_PACKET);
					return;
				}

				if (((L2PcInstance) this).isCursedWeaponEquiped()
						&& ((L2PcInstance) target).getLevel() <= Config.MAX_LEVEL_NEWBIE) {
		...
		if (this instanceof L2Summon && !(this instanceof L2PetInstance)) {
			wasSSCharged = ((L2Summon) this).getChargedSoulShot() != L2ItemInstance.CHARGED_NONE;
				...
				&& ((L2MonsterInstance) this).getTemplate().getRace() == L2NpcTemplate.Race.HUMANOID
				&& !this.isRaid()) {
			if (this.getLevel() > 20 && this.getLevel() >= Rnd.get(100)) {
				wasSSCharged = weaponItem != null;
				if (wasSSCharged) {
					Broadcast.toSelfAndKnownPlayersInRadius(this,
							new MagicSkillUser(this, this, SKILL_IDS[weaponItem.getCrystalType()], 1, 0, 0), 360000);
				}
			} else {
				wasSSCharged = false;
			}
	...
	private boolean doAttackHitByBow(Attack attack, L2Character target, int sAtk, int reuse) {
		...
		if (!miss1) {
			...
			damage1 = (int) Formulas.getInstance().calcPhysDam(this, target, null, shld1, crit1, false,
					attack.soulshot);
		}
		...
		ThreadPoolManager.getInstance().scheduleAi(new HitTask(target, damage1, crit1, miss1, attack.soulshot, shld1),
				sAtk);
	...
	private boolean doAttackHitByDual(Attack attack, L2Character target, int sAtk) {
		...
		ThreadPoolManager.getInstance().scheduleAi(new HitTask(target, damage2, crit2, miss2, attack.soulshot, shld2),
				sAtk);
		...
		for (L2Object obj : getKnownList().getKnownObjects().values()) {
			if (obj instanceof L2Character) {
				...
				if (Math.abs(angleChar - angleTarget) > maxAngleDiff
						...
						&& Math.abs(angleChar - (angleTarget + 360)) > maxAngleDiff) {
					continue;
				}
	...
	private void beginCast(L2Skill skill, boolean simultaneously) {
		...
		if ((isSkillDisabled(skill.getId()))) {
			if (activeChar instanceof L2PcInstance && !(skill.getId() == 2166)) {
				sendPacket(new SystemMessage(SystemMessageId.S1_PREPARED_FOR_REUSE).addSkillName(skill.getId(),
						skill.getLevel()));
		...
		if (skill.getTargetType() == SkillTargetType.TARGET_AURA
				|| skill.getTargetType() == SkillTargetType.TARGET_GROUND || skill.isPotion()) {
			target = this;
			...
			return;
				...
				|| skill.getSkillType() == L2SkillType.COMBATPOINTPERCENTHEAL
				|| skill.getSkillType() == L2SkillType.MANAHEAL || skill.getSkillType() == L2SkillType.REFLECT
				...
				|| skill.getTargetType() == L2Skill.SkillTargetType.TARGET_ALLY) && !skill.isPotion()) {
		...
		if (weaponInst != null && skill.isMagic() && !forceBuff && skill.getTargetType() != SkillTargetType.TARGET_SELF
				&& !skill.isStaticHitTime()) {
			if (weaponInst.getChargedSpiritshot() == L2ItemInstance.CHARGED_BLESSED_SPIRITSHOT
					|| weaponInst.getChargedSpiritshot() == L2ItemInstance.CHARGED_SPIRITSHOT) {
				hitTime = (int) (0.70 * hitTime);
				coolTime = (int) (0.70 * coolTime);

				if (skill.getSkillType() == L2SkillType.BUFF || skill.getSkillType() == L2SkillType.MANAHEAL
						|| skill.getSkillType() == L2SkillType.RESURRECT || skill.getSkillType() == L2SkillType.RECALL
						|| skill.getSkillType() == L2SkillType.DOT) {
		...
		// _castEndTime = 10 + GameTimeController.getGameTicks() + (coolTime + hitTime)
		...
		if (hitTime > 210) {
			// Send a Server->Client packet SetupGauge with the color of the gauge and the
			// casting time
			...
			if (simultaneously) {
				...
				// Create a task MagicUseTask to launch the MagicSkill at the end of the casting
				// time (hitTime)
				// For client animation reasons (party buffs especially) 200 ms before!
				if (effectWhileCasting)
					_skillCast2 = ThreadPoolManager.getInstance()
							.scheduleEffect(new MagicUseTask(targets, skill, coolTime, 2, simultaneously), hitTime);
				else
					_skillCast2 = ThreadPoolManager.getInstance().scheduleEffect(
							new MagicUseTask(targets, skill, coolTime, 1, simultaneously), hitTime - 200);
				...
				// For client animation reasons (party buffs especially) 200 ms before!
				if (effectWhileCasting)
					_skillCast = ThreadPoolManager.getInstance()
							.scheduleEffect(new MagicUseTask(targets, skill, coolTime, 2, simultaneously), hitTime);
				else
					_skillCast = ThreadPoolManager.getInstance().scheduleEffect(
							new MagicUseTask(targets, skill, coolTime, 1, simultaneously), hitTime - 200);
	...
	public boolean isAttackingDisabled() {
		return isImmobileUntilAttacked() || isStunned() || isSleeping()
				|| _attackEndTime > GameTimeController.getGameTicks() || isFakeDeath() || isParalyzed();
	}
	...
	public boolean isMovementDisabled() {
		return isStunned() || isRooted() || isSleeping() || isOverloaded() || isParalyzed() || isImobilised()
				|| isFakeDeath() || isTeleporting();
	}
	...
	public boolean updatePosition(int gameTicks) {
		...
		if (Config.GEODATA > 0 && Config.COORD_SYNCHRONIZE == 2 && !isFlying() && !isInsideZone(L2Character.ZONE_WATER)
		...
		if (distFraction > 1) {
			...
			if (this instanceof L2BoatInstance) {
				((L2BoatInstance) this).updatePeopleInTheBoat((int) m._xAccurate, (int) m._yAccurate,
	...
	protected void moveToLocation(int x, int y, int z, int offset) {
		...
		if (Config.GEODATA > 0 && !isFlying() && (!isInsideZone(ZONE_WATER) || isInsideZone(ZONE_SIEGE))
				&& !(this instanceof L2NpcWalkerInstance)) {
			...
			if (Config.GEODATA == 2
					...
					|| this instanceof L2Summon && !(getAI().getIntention() == AI_INTENTION_FOLLOW)
			...
			// Pathfinding checks. Only when geodata setting is 2, the LoS check gives
			// shorter result
			// than the original movement was and the LoS gives a shorter distance than 2000
			// This way of detecting need for pathfinding could be changed.
			if (((this instanceof L2PcInstance) && Config.ALLOW_PLAYERS_PATHNODE || !(this instanceof L2PcInstance))
					&& Config.GEODATA == 2 && originalDistance - distance > 30 && distance < 2000 && !isAfraid()) {
				// Path calculation
				...
				if (this instanceof L2Playable || isInCombat() || this instanceof L2MinionInstance) {
					...
					if (m.geoPath == null || m.geoPath.length < 2) // No path found
					{
						...
						// after target anyway, is dz is small enough. Summons will follow their masters
						// no matter what.
			...
			if (((this instanceof L2PcInstance) && Config.ALLOW_PLAYERS_PATHNODE || !(this instanceof L2PcInstance))
					&& distance < 1 && (Config.GEODATA == 2 || this instanceof L2Playable
							|| this instanceof L2RiftInvaderInstance || isAfraid())) {
				if (this instanceof L2Summon) {
		...
		// Create a task to notify the AI that L2Character arrives at a check point of
		// the movement
		...
		if (miss) {
			if (target instanceof L2PcInstance) {
				if (this instanceof L2Summon) {
					...
					((L2PcInstance) target)
							.sendPacket(new SystemMessage(SystemMessageId.AVOIDED_S1S_ATTACK).addNpcName(mobId));
				} else {
					((L2PcInstance) target)
							.sendPacket(new SystemMessage(SystemMessageId.AVOIDED_S1S_ATTACK).addString(getName()));
				}
			}
		}

		// If attack isn't aborted, send a message system (critical hit, missed...) to
		// attacker/target if they are L2PcInstance
		if (!isAttackAborted()) {
			if (Config.ALLOW_RAID_BOSS_PUT && (this instanceof L2PcInstance || this instanceof L2Summon)) // Check if
																											// option is
																											// True Or
																											// False.
			{
				...
				if (!(target instanceof L2Playable) && !(target instanceof L2SummonInstance)) { // this must work just
																								// on mobs/raids

					if ((target.isRaid() && getLevel() > target.getLevel() + 8)
							|| (!(target instanceof L2PcInstance)
									&& (target.getTarget() != null && target.getTarget() instanceof L2RaidBossInstance
						...
						if (boss_id != -1) {
							...
							if (boss_template != null && getLevel() > boss_template.getLevel() + 8) {
								...
								if (boss_instance != null
										/* && alive */ && boss_instance.isInsideRadius(this, 3000, false, false)) {
									to_be_cursed = true;
								}
							}
				...
				if (to_be_cursed) {
					...
					if (target instanceof L2MinionInstance) {
						...
						List<L2MinionInstance> spawnedMinions = ((L2MinionInstance) target).getLeader()
								.getSpawnedMinions();
			...
			if (target instanceof L2PcInstance) {
				...
				((L2Summon) target).getOwner()
						.sendPacket(new SystemMessage(SystemMessageId.PET_RECEIVED_S2_DAMAGE_BY_S1).addString(getName())
								.addNumber(damage));
			}
	...
	public void onForcedAttack(L2PcInstance player) {
		...
		if (player.isInOlympiadMode() && player.getTarget() != null && player.getTarget() instanceof L2Playable) {
			...
			if (target.isInOlympiadMode() && !player.isOlympiadStart()
	...
	public Boolean isInActiveRegion() {
		try {
			...
			if (this instanceof L2PcInstance) {
				_log.warning("Player " + getName() + " at bad coords: (x: " + getX() + ", y: " + getY() + ", z: "
						+ getZ() + ").");
				...
				_log.warning("Object " + getName() + " at bad coords: (x: " + getX() + ", y: " + getY() + ", z: "
						+ getZ() + ").");
				decayMe();
			}
			return false;
	...
	public L2Skill addSkill(L2Skill newSkill) {
		...
		if (newSkill != null) {
			...
			if (newSkill.isChance() && newSkill.triggerAnotherSkill()) {
				L2Skill triggeredSkill = SkillTable.getInstance().getInfo(newSkill.getTriggeredId(),
						newSkill.getTriggeredLevel());
	...
	public void onMagicLaunchedTimer(L2Object[] targets, L2Skill skill, int coolTime, boolean instant,
		...
		// Escaping from under skill's radius and peace zone check. First version, not
		// perfect in AoE skills.
		int escapeRange = 0;
		...
		if (instant) {
			...
			_skillCast = ThreadPoolManager.getInstance()
					.scheduleEffect(new MagicUseTask(targets, skill, coolTime, 2, simultaneously), 200);
		}
	...
	public void onMagicHitTimer(L2Object[] targets, L2Skill skill, int coolTime, boolean instant,
				...
				for (int i = 0; i < targets2.length; i++)// L2Object target2 : targets)
				{
					...
					if (target2 instanceof L2Playable) {
						...
						if (this instanceof L2PcInstance && target instanceof L2Summon) {
							...
							// The PetInfo packet wipes the PartySpelled (list of active spells' icons).
							// Re-add them
		...
		try {
			...
			// Consume MP of the L2Character and Send the Server->Client packet StatusUpdate
			// with current HP and MP to all other L2PcInstance to inform
			...
			// Consume HP if necessary and Send the Server->Client packet StatusUpdate with
			// current HP and MP to all other L2PcInstance to inform
			...
			// Send a Server->Client packet StatusUpdate with MP modification to the
			// L2PcInstance
			if (isSendStatus) {
				sendPacket(su);
			}

			// Consume Items if necessary and Send the Server->Client packet InventoryUpdate
			// with Item modification to all the L2Character
		...
		if (instant || coolTime == 0) {
			...
			if (simultaneously)
				_skillCast2 = ThreadPoolManager.getInstance()
						.scheduleEffect(new MagicUseTask(targets, skill, coolTime, 3, simultaneously), coolTime);
			else
				_skillCast = ThreadPoolManager.getInstance()
						.scheduleEffect(new MagicUseTask(targets, skill, coolTime, 3, simultaneously), coolTime);
		}
	...
	public void onMagicFinalizer(L2Object[] targets, L2Skill skill, boolean simultaneously) {
		...
		if (skill.nextActionIsAttack() && getTarget() instanceof L2Character && getTarget() != this
				&& getTarget() == target && target.isAttackable()) {
		...
		if (this instanceof L2PcInstance) {
			...
			if (queuedSkill != null) {
				...
				ThreadPoolManager.getInstance().executeTask(new QueuedMagicUseTask(currPlayer, queuedSkill.getSkill(),
		...
		if (this instanceof L2NpcInstance) {
			try {
				if (((L2NpcTemplate) getTemplate()).getEventQuests(Quest.QuestEventType.ON_SPELL_FINISHED) != null) {
					...
					if (player != null)
						for (Quest quest : ((L2NpcTemplate) getTemplate())
								.getEventQuests(Quest.QuestEventType.ON_SPELL_FINISHED)) {
	...
	public boolean isSkillDisabled(int skillId) {
		...
		if (this instanceof L2PcInstance) {
			...
			if ((skill.getSkillType() == L2SkillType.FISHING || skill.getSkillType() == L2SkillType.REELING
					|| skill.getSkillType() == L2SkillType.PUMPING) && !activeChar.isFishing()
					&& (activeChar.getActiveWeaponItem() != null
							&& activeChar.getActiveWeaponItem().getItemType() != L2WeaponType.ROD)) {
			...
			if ((skill.getSkillType() == L2SkillType.FISHING || skill.getSkillType() == L2SkillType.REELING
					|| skill.getSkillType() == L2SkillType.PUMPING) && activeChar.getActiveWeaponItem() == null) {
				SystemMessage sm = new SystemMessage(SystemMessageId.S1_CANNOT_BE_USED);
				sm.addString(skill.getName());
				activeChar.sendPacket(sm);
				return true;
			...
			if ((skill.getSkillType() == L2SkillType.REELING || skill.getSkillType() == L2SkillType.PUMPING)
					&& !activeChar.isFishing() && (activeChar.getActiveWeaponItem() != null
							&& activeChar.getActiveWeaponItem().getItemType() == L2WeaponType.ROD)) {
				if (skill.getSkillType() == L2SkillType.PUMPING) {
					activeChar.sendPacket(new SystemMessage(SystemMessageId.CAN_USE_PUMPING_ONLY_WHILE_FISHING));
				} else if (skill.getSkillType() == L2SkillType.REELING) {
			...
			if (activeChar.isHero() && HeroSkillTable.isHeroSkill(skillId) && activeChar.isInOlympiadMode()
			...
			for (L2Object target : targets) {
				if (target instanceof L2Character) {
					...
					if (activeWeapon != null && !((L2Character) target).isDead()) {
						if (activeWeapon.getSkillEffects(this, player, skill).length > 0
								&& this instanceof L2PcInstance) {
						...
						if (!(target instanceof L2Playable) && !(target instanceof L2SummonInstance)) {
							if ((player.isRaid() && getLevel() > player.getLevel() + 8)
									...
									|| (!(player instanceof L2PcInstance) && (player.getTarget() != null
											...
											&& getLevel() > ((L2GrandBossInstance) player.getTarget()).getLevel()
													+ 8))) {
								to_be_cursed = true;
							}
							...
							if (!to_be_cursed) {
								...
								if (boss_id != -1) {
									...
									if (boss_template != null && getLevel() > boss_template.getLevel() + 8) {
										...
										if (boss_template.type.equals("L2RaidBoss")) {
											StatsSet actual_boss_stat = RaidBossSpawnManager.getInstance()
													.getStatsSet(boss_id);
											if (actual_boss_stat != null) {
												boss_instance = RaidBossSpawnManager.getInstance().getBoss(boss_id);
											}
										} else if (boss_template.type.equals("L2GrandBoss")) {
											StatsSet actual_boss_stat = GrandBossManager.getInstance()
													.getStatsSet(boss_id);
											if (actual_boss_stat != null) {
												boss_instance = GrandBossManager.getInstance().getBoss(boss_id);
											}
										...
										if (boss_instance != null
												&& boss_instance.isInsideRadius(this, 3000, false, false)) {
											to_be_cursed = true;
										}
									}
								}
						...
						if (to_be_cursed) {
							if (skill.isMagic()) {
								...
								if (player instanceof L2MinionInstance) {
									...
									List<L2MinionInstance> spawnedMinions = ((L2MonsterInstance) player)
											.getSpawnedMinions();
									if (spawnedMinions != null && spawnedMinions.size() > 0) {
										Iterator<L2MinionInstance> itr = spawnedMinions.iterator();
										L2MinionInstance minion;
					...
					if (activeChar != null) {
						if (skill.isOffensive()) {
							...
							if (player instanceof L2PcInstance) {
								if (!player.equals(this) && (((L2PcInstance) player).getPvpFlag() > 0
										|| ((L2PcInstance) player).getKarma() > 0)) {
									activeChar.updatePvPStatus();
								}
							} else if (player instanceof L2Attackable && !(skill.getSkillType() == L2SkillType.SUMMON)
				...
				if (skill.getAggroPoints() > 0) {
					for (L2Object spMob : caster.getKnownList().getKnownObjects().values()) {
						if (spMob instanceof L2Npc) {
							...
							if (npcMob.isInsideRadius(caster, 1000, true, true) && npcMob.hasAI()
	...
	public boolean reflectSkill(L2Skill skill) {
		double reflect = calcStat(skill.isMagic() ? Stats.REFLECT_SKILL_MAGIC : Stats.REFLECT_SKILL_PHYSIC, 0, null,
				null);
