...
import static com.gameserver.ai.CtrlIntention.AI_INTENTION_ACTIVE;
...
import com.gameserver.managers.CustomNpcInstanceManager;
...
import com.gameserver.model.L2NpcAIData;
import com.gameserver.model.L2Object;
import com.gameserver.model.L2Skill;
import com.gameserver.model.L2World;
import com.gameserver.model.actor.instance.L2CastleTeleporterInstance;
import com.gameserver.model.actor.instance.L2ControlTowerInstance;
import com.gameserver.model.actor.instance.L2CustomNpcInstance;
import com.gameserver.model.actor.instance.L2FestivalGuideInstance;
import com.gameserver.model.actor.instance.L2FishermanInstance;
import com.gameserver.model.actor.instance.L2ItemInstance;
import com.gameserver.model.actor.instance.L2MerchantInstance;
import com.gameserver.model.actor.instance.L2NpcInstance;
import com.gameserver.model.actor.instance.L2PcInstance;
import com.gameserver.model.actor.instance.L2TeleporterInstance;
import com.gameserver.model.actor.instance.L2WarehouseInstance;
import com.gameserver.model.actor.knownlist.NpcKnownList;
import com.gameserver.model.actor.stat.NpcStat;
import com.gameserver.model.actor.status.NpcStatus;
import com.gameserver.model.entity.Hero;
import com.gameserver.model.entity.event.Lottery;
...
import com.gameserver.model.multisell.L2Multisell;
...
import com.gameserver.network.clientpackets.Say2;
import com.gameserver.network.serverpackets.ActionFailed;
import com.gameserver.network.serverpackets.ExShowVariationCancelWindow;
import com.gameserver.network.serverpackets.ExShowVariationMakeWindow;
...
import com.gameserver.network.serverpackets.NpcSay;
import com.gameserver.network.serverpackets.RadarControl;
...
import com.gameserver.taskmanager.DecayTaskManager;
import com.gameserver.templates.L2HelperBuff;
...
public class L2Npc extends L2Character
{
	...
	public void showLotoWindow(L2PcInstance player, int val)
	{
		...
		else if(val > 24)
		{
			...
			player.sendPacket(new SystemMessage(SystemMessageId.S2_S1_DISAPPEARED).addItemName(4442));
	...
	public void showChatWindow(L2PcInstance player, int val)
	{
		...
		if(player.getKarma() > 0)
		{
			...
			else if(!Config.KARMA_PLAYER_CAN_USE_WAREHOUSE && this instanceof L2WarehouseInstance)
			{
