 ...
 */
package com.gameserver.model.entity.clanhallsiege;
...
public class DevastatedCastle
{
	...
	private static final int BOSS_ID = 35410;
	private static final int BOSS1_ID = 35408;
	private static final int BOSS2_ID = 35409;
	...
	public void MessengerSpawn()
	{
		...
		Announce("Registration for the Devastated Castle siege is open!");
		...
		ThreadPoolManager.getInstance().scheduleGeneral(new AnnounceInfo("Registration for the Devastated Castle siege is over!"), 7200000);
	...
	public void Siege()
	{
		...
		try
		{
			...
			spawn.stopRespawn();
			result = spawn.spawnOne();
			_gustav = ThreadPoolManager.getInstance().scheduleGeneral(new DeSpawnTimer(result), 3600000);
			...
			_dietrich = ThreadPoolManager.getInstance().scheduleGeneral(new DeSpawnTimer(_minion1), 3600000);
			...
			_mikhail = ThreadPoolManager.getInstance().scheduleGeneral(new DeSpawnTimer(_minion2), 3600000);
	...
	public void SiegeFinish()
	{
		...
		if(clanIdMaxDamage != null)
		{
			...
			Announce("Devastated Castle siege is over.");
