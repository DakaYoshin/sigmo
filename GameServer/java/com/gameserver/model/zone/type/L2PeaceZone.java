 ...
 */
package com.gameserver.model.zone.type;
...
public class L2PeaceZone extends L2ZoneType
{
	...
	protected void onEnter(L2Character character)
	{
		...
		{
			((L2PcInstance)character).sendPacket(new SystemMessage(SystemMessageId.ENTER_PEACEFUL_ZONE));
		}
	}
	...
	protected void onExit(L2Character character)
	{
		...
		if (character instanceof L2PcInstance)
		{
			((L2PcInstance)character).sendPacket(new SystemMessage(SystemMessageId.EXIT_PEACEFUL_ZONE));
		}
	}
