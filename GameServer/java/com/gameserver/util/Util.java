...
public final class Util {
	...
	public static double calculateDistance(L2Object obj1, L2Object obj2, boolean includeZAxis) {
		...
		return calculateDistance(obj1.getPosition().getX(), obj1.getPosition().getY(), obj1.getPosition().getZ(),
				obj2.getPosition().getX(), obj2.getPosition().getY(), obj2.getPosition().getZ(), includeZAxis);
	}
	...
	/**
	 * Calculates the direction to the target object relative to the source object's
	 * heading.
	 * 
	 * @param obj1 The source object.
	 * @param obj2 The target object.
	 * @return The angle in degrees (-180 to 180). Positive values indicate the
	 *         target is to the left, negative to the right.
	 */
	public static double calculateDirectionTo(L2Character obj1, L2Object obj2) {
		double angleTarget = Math.toDegrees(Math.atan2(obj2.getY() - obj1.getY(), obj2.getX() - obj1.getX()));
		if (angleTarget < 0) {
			angleTarget += 360;
		}

		double angleChar = convertHeadingToDegree(obj1.getHeading());
		double angle = angleTarget - angleChar;
