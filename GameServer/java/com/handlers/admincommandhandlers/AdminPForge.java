...
import com.gameserver.network.serverpackets.AdminForgePacket;
...
public class AdminPForge implements IAdminCommandHandler
{
	...
	public boolean useAdminCommand(String command, L2PcInstance activeChar)
	{
		...
		else if(command.startsWith("admin_forge2"))
		{
			...
			{
				ex.printStackTrace();
				activeChar.sendChatMessage(0, 0, "SYS", "Usage: //forge2 format");
			}
		}
	...
	{
		AdminHelpPage.showHelpPage(activeChar, "gm/pforge1.htm");
	}

	private void showPage2(L2PcInstance activeChar, String format)
	{
		NpcHtmlMessage adminReply = new NpcHtmlMessage(5);
		adminReply.setFile("data/html/admin/gm/pforge2.htm");
	...
	{
		NpcHtmlMessage adminReply = new NpcHtmlMessage(5);
		adminReply.setFile("data/html/admin/gm/pforge3.htm");
		adminReply.replace("%format%", format);
