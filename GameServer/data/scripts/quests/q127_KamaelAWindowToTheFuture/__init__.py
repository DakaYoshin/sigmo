...
from com.gameserver.network.serverpackets import ExShowSlideshowKamael

qn = "q127_KamaelAWindowToTheFuture"
...
STARTED.addQuestDrop(KLAUS,MARK_HUMAN,1)
STARTED.addQuestDrop(ALDER,MARK_DWARF,1)
STARTED.addQuestDrop(AKLAN,MARK_ORC,1)
STARTED.addQuestDrop(OLTLIN,MARK_DELF,1)
STARTED.addQuestDrop(JURIS,MARK_ELF,1)
STARTED.addQuestDrop(DOMINIC,MARK_DOMINIC,1)