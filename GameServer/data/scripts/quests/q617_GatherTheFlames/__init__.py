...
class Quest (JQuest) :
 ...
 def onAdvEvent (self,event,npc,player):
     ...
     if event == "31539-03.htm" or event == "31271-03.htm":
...
STARTED.addQuestDrop(HILDA,TORCH,1)
