...
qn = "q86_SagaOfTheHierophant"
qnu = 86
qna = "Saga of the Hierophant"
...
class Quest (JQuest) :
 ...
 def __init__(self,id,name,descr):
     ...
     self.NPC = [30191,31626,31588,31280,31591,31646,31648,31652,31654,31655,31659,31280]
     self.Items = [7080,7523,7081,7501,7284,7315,7346,7377,7408,7439,7089,0]
     self.Mob = [27269,27235,27275]
     self.qn = qn
     self.classid = 98
     self.prevclass = 0x11
