...
start     = "<html><body>Head Researcher Sobling:<br><br>As leader of the research team i'm looking for experienced adventurers to join us. Actually we're searching for relics from the ancient Giants Culture. There are four scripts we can't find yet: <font color=\"LEVEL\">Plans for the construction of Golems, Basis of the Giant's Magic, Construction Technology Handbook and Giant's Medical Theory.</font><br><br>Given the value of the items we're looking for, there is no need to tell you how generous shall be my rewards.<br><br><a action=\"bypass -h Quest q376_GiantsExploration1 yes\">I will search for ancient items</a><br><a action=\"bypass -h Quest q376_GiantsExploration1 0\">I won't help you</a><br></body></html>"
starting  = "Starting.htm"
checkout  = "<html><body>Head Researcher Sobling:<br><br>Excellent! You came back! Was it difficult to collect ancient pieces?<br><br>Let me see what you've found thus far...<br><br><a action=\"bypass -h Quest q376_GiantsExploration1 show\">Show him the books you collected</a><br><a action=\"bypass -h Quest q376_GiantsExploration1 myst\">Show him another items you've found</a><br></body></html>"
checkout2 = "<html><body>Head Researcher Sobling:<br><br>Excellent! You came back! Was it difficult to collect ancient pieces?<br><br>Hum... what is it? You have some ancient scrolls here, but those are of no use to me until you translate its contents, i have no time to do it on my own and that's why i gave you the dictionary. Anyway i can check any other ancient item you may have...<br><br><a action=\"bypass -h Quest q376_GiantsExploration1 show\">Show him the scrolls you collected</a><br><a action=\"bypass -h Quest q376_GiantsExploration1 myst\">Show him another items you've found</a><br></body></html>"
no_items  = "<html><body>Head Researcher Sobling:<br><br>Hum... I see no valuable items here, you should continue your research. I'm pretty sure you can do it better if you put more effort... what you think?<br><br><a action=\"bypass -h Quest q376_GiantsExploration1 Starting.htm\">I will continue</a><br><a action=\"bypass -h Quest q376_GiantsExploration1 0\">I will quit</a><br></body></html>"
tnx4items = "<html><body>Head Researcher Sobling:<br><br>Amazing! These are the sort of items i was looking for... Take this rare recipes as a proof of my gratitude. Anyhow, I'm sure there are more ancient relics guarded by those monsters, would you like to search some more?<br><br><a action=\"bypass -h Quest q376_GiantsExploration1 Starting.htm\">I will continue</a><br><a action=\"bypass -h Quest q376_GiantsExploration1 0\">I will quit</a><br></body></html>"
...
QUEST       = Quest(376, qn, "Exploration of Giants Cave, part 1")
