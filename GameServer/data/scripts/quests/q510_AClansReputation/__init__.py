...
from com.gameserver.network.serverpackets      import PledgeShowInfoUpdate
from com.gameserver.network.serverpackets      import RadarControl
from com.gameserver.network.serverpackets      import SystemMessage
  ...
  if player.getClan() == None or player.isClanLeader() == 0 :
     ...
     if id == CREATED and cond == 0 :
        ...
        if not count :
           ...
           clan.addReputationScore(clan.getReputationScore()+CLAN_POINTS_REWARD*count,True)
