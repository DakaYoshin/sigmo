...
qn = "q77_SagaOfTheDominator"
qnu = 77
qna = "Saga of the Dominator"
...
class Quest (JQuest) :
 ...
 def __init__(self,id,name,descr):
     ...
     self.NPC = [31336,31624,31371,31290,31636,31646,31648,31653,31654,31655,31656,31290]
     self.Items = [7080,7539,7081,7492,7275,7306,7337,7368,7399,7430,7100,0]
     self.Mob = [27294,27226,27262]
     self.qn = qn
     self.classid = 115
     self.prevclass = 0x33
