...
qn = "q74_SagaOfTheDreadnoughts"
qnu = 74
qna = "Saga of the Dreadnoughts"
...
class Quest (JQuest) :
 ...
 def __init__(self,id,name,descr):
     ...
     self.NPC = [30850,31624,31298,31276,31595,31646,31648,31650,31654,31655,31657,31522]
     self.Items = [7080,7538,7081,7489,7272,7303,7334,7365,7396,7427,7097,6480]
     self.Mob = [27290,27223,27282]
     self.qn = qn
     self.classid = 89
     self.prevclass = 0x03
