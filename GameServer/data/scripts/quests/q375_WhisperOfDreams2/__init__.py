# Whisper of L2jSigmos, part 2 version 0.1 
# by DrLecter
#Updated by RusTeam
import sys
...
#Quest info
QUEST_NUMBER,QUEST_NAME,QUEST_DESCRIPTION = 375,"WhisperOfL2jSigmos2","Whisper of L2jSigmos, part 2"
qn = "q375_WhisperOfL2jSigmos2"
...
class Quest (JQuest) :
 ...
 def onTalk (self,npc,player):
   ...
   if id == CREATED :
      ...
      if st.getQuestItemsCount(CH_SKULL) >= 100 and st.getQuestItemsCount(K_HORN) >= 100 :
         st.takeItems(CH_SKULL,100)
         st.takeItems(K_HORN,100)
...
QUEST       = Quest(QUEST_NUMBER, "q"+str(QUEST_NUMBER)+"_"+QUEST_NAME, QUEST_DESCRIPTION)
