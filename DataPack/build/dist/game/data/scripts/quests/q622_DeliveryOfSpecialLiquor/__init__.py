...
qn = "q622_DeliveryOfSpecialLiquor"
   ...
   if st :
        ...
        if npcId == 31521 and cond == 0 :
         if player.getLevel() >= 68 :
           ...
           elif npcId == 31267 and cond == 6 and st.getQuestItemsCount(FEE_OF_DRINK) == 5 :
                 htmltext = "31267-0.htm"
   return htmltext
