# Whisper of L2jSigmos, part 1 version 0.1 
# by DrLecter
#Updated by RusTeam
import sys
...
def render_shop() :
    ...
    for i in SHOP_LIST.keys() :
       ...
       html += "<tr><td><a action=\"bypass -h Quest q374_WhisperOfL2jSigmos1 "+str(i)+"\"><font color=\"FFFFFF\">"+SHOP_LIST[i][3]+" x"+str(SHOP_LIST[i][1])+"</font></a></td></tr>"
       html += "<tr><td><a action=\"bypass -h Quest q374_WhisperOfL2jSigmos1 "+str(i)+"\"><font color=\"B09878\">"+str(SHOP_LIST[i][2]*ADENA_X)+" adena</font></a></td></tr></table></td></tr>"
...
class Quest (JQuest) :
 ...
 def onEvent (self,event,st) :
    ...
    if event == "30515-4.htm" :
       ...
       if st.getQuestItemsCount(CB_TOOTH) >= 65 and st.getQuestItemsCount(DW_LIGHT) >= 65 :
          st.set("allow","1")
          st.takeItems(CB_TOOTH,65)
          st.takeItems(DW_LIGHT,65)
          st.set("awaitTooth","1")
          st.set("awaitLight","1")
...
QUEST       = Quest(374, qn, "Whisper of L2jSigmos, part 1")
