...
qn = "q75_SagaOfTheTitan"
qnu = 75
qna = "Saga of the Titan"
...
class Quest (JQuest) :
 ...
 def __init__(self,id,name,descr):
     ...
     self.NPC = [31327,31624,31289,31290,31607,31646,31649,31651,31654,31655,31658,31290]
     self.Items = [7080,7539,7081,7490,7273,7304,7335,7366,7397,7428,7098,0]
     self.Mob = [27292,27224,27283]
     self.qn = qn
     self.classid = 113
     self.prevclass = 0x2e
