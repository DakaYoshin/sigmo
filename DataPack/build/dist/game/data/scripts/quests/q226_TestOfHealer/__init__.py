...
# Edited by Bibigon for RT v.01 03.04.08
...
DROPLIST={
27134:[2,1,0],
27123:[11,1,SECRET_LETTER1],
27124:[14,1,SECRET_LETTER2],
27125:[16,1,SECRET_LETTER3],
27127:[18,1,SECRET_LETTER4]
}
...
# Perrin
   ...
   elif npcId == 30428 and st.getInt("cond")==4 :
      htmltext = "30428-04.htm"

# Orphan Girl
   elif npcId == 30659 and st.getInt("cond") == 7 :
        n = st.getRandom(5)
        if n == 0:
...
# Allana
     ...
     elif npcId == 30424 and st.getInt("cond") == 5 :
      htmltext = "30424-02.htm"

# Gupu
   elif npcId == 30658 :
     if st.getInt("cond") == 5 and st.getQuestItemsCount(PICTURE_OF_WINDY)==0 and st.getQuestItemsCount(WINDYS_PEBBLES)==0 and st.getQuestItemsCount(GOLDEN_STATUE)==0 :
       htmltext = "30658-01.htm"
     elif st.getInt("cond") == 5 and st.getQuestItemsCount(PICTURE_OF_WINDY) :
      htmltext = "30658-04.htm"
     elif st.getInt("cond") == 8 and st.getQuestItemsCount(WINDYS_PEBBLES) :
...
# Windy Shaoring
     ...
     if st.getInt("cond") == 7 and st.getQuestItemsCount(PICTURE_OF_WINDY) :
      htmltext = "30660-01.htm"
     elif st.getInt("cond") == 5 and st.getQuestItemsCount(WINDYS_PEBBLES) :
...
# Sorius
     ...
     if st.getInt("cond") == 9 :
      ...
      st.set("cond","10")
     elif st.getInt("cond") > 6 and st.getInt("cond")<13 :
...
# Daurin Hammercrush
     ...
     if st.getInt("cond") == 10 and st.getQuestItemsCount(ORDER_OF_SORIUS) :
      ...
      st.addSpawn(27122,player.getX()+50,player.getY()+50,player.getZ())
      st.addSpawn(27122,player.getX()+100,player.getY()+133,player.getZ())
      st.addSpawn(27123,player.getX()+130,player.getY()+5,player.getZ())
...
# Kein Flying Knife
     ...
     if st.getInt("cond") == 8 or st.getInt("cond") == 9:
...
# Mysterious Dark Elf
     ...
     if st.getInt("cond") == 13 :
      ...
      st.addSpawn(27124,player.getX()+50,player.getY()+50,player.getZ())
      st.addSpawn(27124,player.getX()+100,player.getY()+133,player.getZ())
      st.addSpawn(27124,player.getX()+130,player.getY()+5,player.getZ())
      st.playSound("Itemsound.quest_before_battle")
      st.set("cond","14")
     elif st.getInt("cond") == 15:
      htmltext = "30661-02.htm"
      st.addSpawn(27125,player.getX()+130,player.getY()+5,player.getZ())
      st.addSpawn(27125,player.getX()+100,player.getY()+133,player.getZ())
      st.addSpawn(27125,player.getX()+130,player.getY()+5,player.getZ())
      st.playSound("Itemsound.quest_before_battle")
      st.set("cond","16")
     elif st.getInt("cond") == 17:
      htmltext = "30661-03.htm"
      st.addSpawn(27126,player.getX()+50,player.getY()+50,player.getZ())
      st.addSpawn(27126,player.getX()+100,player.getY()+133,player.getZ())
      st.addSpawn(27127,player.getX()+130,player.getY()+5,player.getZ())
      st.playSound("Itemsound.quest_before_battle")
      st.set("cond","18")
