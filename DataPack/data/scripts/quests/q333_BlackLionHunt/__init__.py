...
html        = "<html><body>"
htmlend        = "</body></html>"
back        = "<a action=\"bypass -h Quest q333_BlackLionHunt f_more_help\">Return</a>"
#Sophya
sophia        = "Mercenary Sophia:<br>"
#-Item information
p_redfoot      = html+sophia+"Red foot  you may not like him much personally.  But he is the type of person who is missed when he is not around.  Although he is in charge of delivery of military supplies, he also works on the side as a broker of stolen war trophies and loot.  He is also a great source of information for our mercenary troops.  Since he brings with him quite a lot of useful information, stop by often to ask him questions.<br><a action=\"bypass -h Quest q333_BlackLionHunt p_trader_info\">Ask about the traders union.</a><br><a action=\"bypass -h Quest q333_BlackLionHunt continue\">Continue with your mission.</a><br><a action=\"bypass -h Quest q333_BlackLionHunt leave\">Stop the mission you have been engaged in.</a>"+htmlend
p_no_items      = html+sophia+"Dear brother of the Black Lion.  Dont you think that the place where you should be is not in this village but in the battlefield where the evil spirits are running wild!<br><a action=\"bypass -h Quest q333_BlackLionHunt continue\">Continue with your mission.</a><br><a action=\"bypass -h Quest q333_BlackLionHunt leave\">Stop the mission you have been engaged in.</a>"+htmlend
p_trader_info    = html+sophia+"This cargo box definitely belongs to the Aden Traders Union. I can tell from the seal that is stamped on the box. If you want to return the cargo to them, go see Trader Union Member Morgan at the magic grocery store.  He works for the Aden Traders Union. <br><a action=\"bypass -h Quest q333_BlackLionHunt p_redfoot\">Ask about Red Foot. </a><br><a action=\"bypass -h Quest q333_BlackLionHunt continue\">Continue with your mission. </a><br><a action=\"bypass -h Quest q333_BlackLionHunt leave\">Stop the mission you have been engaged in.</a>"+htmlend
p_both_info      = html+sophia+"Dear brother.  I appreciate your hard work in carrying out the mission.  Ill give you your reward according to the number of proofs you have brought back.<br>What is that box?  It seems like you have brought back a cargo box that belongs to a traders union.  Since there is no clause regarding the returning of a cargo box written in our contract,  I guess we dont have the duty to return the cargo to the traders. But, if we return it to the traders union, perhaps they will give us some sort of reward?   If you dont feel like helping traders, you can go see Red Foot.   He is an expert in dealing with spoils that are hard to get rid of. <br><a action=\"bypass -h Quest q333_BlackLionHunt p_redfoot\">Ask about Red Foot. </a><br><a action=\"bypass -h Quest q333_BlackLionHunt p_trader_info\">Ask about the traders union.</a><br> <a action=\"bypass -h Quest q333_BlackLionHunt continue\">Continue with your mission.</a><br><a action=\"bypass -h Quest q333_BlackLionHunt leave\">Stop the mission you have been engaged in.</a>"+htmlend
p_only_item_info  = html+sophia+"Dear brother.  I appreciate your hard work in carrying out the mission. Ill give you your reward according to the number of proofs you have brought back.<br><a action=\"bypass -h Quest q333_BlackLionHunt continue\">Continue to carry out the mission.</a><br><a action=\"bypass -h Quest q333_BlackLionHunt leave\">Stop the mission you have been engaged in.</a>"+htmlend
p_leave_mission    = html+sophia+"I appreciate your hard work so far.  Even a lion needs a break.   Retire to the village and replenish your energy while resting there.  Maintaining ones own physical strength is one of the basic skills of being a mercenary.<br><a action=\"bypass -h Quest q333_BlackLionHunt start_chose_parts\">Tell him that you would like to take on a new mission.</a><br><a action=\"bypass -h Quest q333_BlackLionHunt r_exit\">Leave the mercenary troop.</a>"+htmlend
...
start_start      = html+sophia+"Dear brother of the Black Lion.  Our current situation is as follows.  As I said before, our current mission is to drive out the evil spirits in this area.  However, since the main force of the mercenary troop has been dispatched to Gludio, our military force is suffering a shortage.  The only thing we are managing to do right now is to contain the evil spirits from attacking the village. <br>Fortunately, Captain Leopold of Gludin has sent many newly selected mercenary brothers.  So we can launch our attack on the stronghold of the evil spirits in earnest.  Brother, I would like you to join us in this fight.<br><a action=\"bypass -h Quest q333_BlackLionHunt start\">Tell him that you will join them in the fight.</a>"+htmlend
start_explain    = html+sophia+"All right!  The time has come for the black lions that have been crouching until now, to bare their claws and start hunting!<br>Now, I will explain our combat situation.  We currently have four targets of attack.  They are the Execution Ground, the Partisan Hideaway, southern shoreline area, and the Cruma Marshlands.  Since we do not have enough combat power to hold a drawn-out war, we will dispatch a small group of soldiers as a strike force to carry out the strategy of hit and run to drive out the evil spirits.<br><a action=\"bypass -h Quest q333_BlackLionHunt start_parts\">Listen to the mission of each area.</a>"+htmlend
start_parts      = html+sophia+"About which mission would you like to hear about?<br><br><a action=\"bypass -h Quest q333_BlackLionHunt p1_explanation\">Clean out the undead in the Execution Ground.</a><br><a action=\"bypass -h Quest q333_BlackLionHunt p2_explanation\">Drive out the ol mahum in the Partisan Hideaway.</a><br><a action=\"bypass -h Quest q333_BlackLionHunt p3_explanation\">Drive out the delu lizardman in the southern shore area.</a><br><a action=\"bypass -h Quest q333_BlackLionHunt p4_explanation\">Smash the marsh stakato in the Cruma Marshlands.</a>"+htmlend
start_ask_again    = html+sophia+"Dear Black Lion brother, the war with the evil spirits has already started! Dont you think you should be active in this fight with us?<br><a action=\"bypass -h Quest q333_BlackLionHunt start_parts\">Listen to the explanation about the mission.</a>"+htmlend
start_continue    = html+sophia+"Hurry!  Rush to the battlefield, destroy your enemies and taste the sweetness of victory!"+htmlend
#-Part 1
p1_explanation    = html+sophia+"The Execution Ground is located in the eastern part of the village. It is an eerie place where people can hear the never ending cries of dead souls. Your mission is to clean out the undead that are infesting the place. According to a rumor, in order to pay for the spilled blood of innocent people who were killed during the farmers uprising, the undead came back to this world Well, all I know is that we need to carry out the given assignment. Still, I dont feel good about this for some reason. <br><a action=\"bypass -h Quest q333_BlackLionHunt p1_t\">Take on the mission.</a><br><a action=\"bypass -h Quest q333_BlackLionHunt start_chose_parts\">Listen to the explanation about another mission.</a>"+htmlend
...
#-Part 3
p3_explanation    = html+sophia+"The headquarters of delu lizardmen was originally located at the shore area in the southern part of Giran.  However, lately, many of them are infiltrating into Dion territory.  We dont know yet whether they are entering Dion just to find food or to prepare some large scale invasion.  But what is clear is that they are making their movements with some clear goal.  Our mission is to smash their units one by one and instill fear in them thereby discouraging them from settling down in this area.<br><a action=\"bypass -h Quest q333_BlackLionHunt p3_t\">Take on the mission.</a> <br> <a action=\"bypass -h Quest q333_BlackLionHunt start_chose_parts\">Listen to the explanation about another mission.</a>"+htmlend
...
f_no_box      = html+redfoot+"Hey brother!  Did you tell me that youre currently on active duty?  I know that must be hard work!  Is there anything I can help you with?<br><a action=\"bypass -h Quest q333_BlackLionHunt f_info\">Ask whether he has any useful information.</a>"+htmlend
f_give_box      = html+redfoot+"Hey brother!  Did you tell me that youre currently on active duty?  I know that must be hard work!  Is there anything I can help you with?<br>What kind of box is that?  Oh, I know.  Thats a cargo box used by traders.  Since you brought it to me  I can assume that you dont have any intention of returning it to the merchant, am I right?  All right.  Ill open the box for you.  Of course, you can have the contents of the box.  Instead, Ill charge you a small fee.  I think <font color=\"LEVEL\">650 adena</font> will be appropriate.  Think of it as the price for opening the box and for keeping my mouth shut.<br><a action=\"bypass -h Quest q333_BlackLionHunt f_give\">Ask him to open the box for you.</a><br>"+back+htmlend
f_rnd_list      = ["Some time ago, I overheard some dwarves talking among themselves in a blacksmiths shop  The head of the dwarves perhaps he is called the first elder?  Anyway, he was desperately looking for a scroll that had hieroglyphic characters of giants on it.  Although I didnt get to hear the details, it seemed like some very critical secret regarding the giants scientific technology was written on it.  I always thought that dwarves were just busying themselves with their work in blacksmith shops and being warehouse keepers.  But what do you know  I think they have been working on secret things while avoiding the scrutiny of humans.<br>",
             ...
             "In this village, there is a young man who is L2jSigmoing of becoming the best chef in the kingdom.  His name is Jonas.  Lately he has been working hard to prepare himself to compete in a culinary competition.   He is looking for an adventurer who can find ingredients to make exotic dishes<br>",
...
f_more_help      = html+redfoot+"Is there anything else I can help you with?<br><a action=\"bypass -h Quest q333_BlackLionHunt f_give\">Ask him to open the box for you.</a>"+htmlend
f_no_more_box    = html+redfoot+"I dont know what to say to you!  You dont even have a Cargo Box with you.  But are you still asking me to open one?<br><br><a action=\"bypass -h Quest q333_BlackLionHunt f_info\">Ask whether he has any useful information.</a>"+htmlend
f_more_help2    = html+redfoot+"Is there anything else you would like me to help you with?<br><a action=\"bypass -h Quest q333_BlackLionHunt f_give\">Ask him to open the cargo box for you.</a><br><a action=\"bypass -h Quest q333_BlackLionHunt f_info\">Ask him whether he has any useful information for you.</a>"+htmlend
...
r_items        = html+rupio+"What can I help with?<br><a action=\"bypass -h Quest q333_BlackLionHunt r_give_statue\">Ask to put together pieces of statue.</a><br><a action=\"bypass -h Quest q333_BlackLionHunt r_give_tablet\">Ask to put together stone tablet."+htmlend
...
l_tablet      = html+lockirin+"This clay tablet... Where in the world could...?! It's just one part, but... Maphr...!  Where did such a precious thing...? Look at this, young fellow! I'll present to you a big gift of gratitude so please give this tablet to me!<br><a action=\"bypass -h Quest q333_BlackLionHunt l_give\">Hand over clay tablet.</a><br><a action=\"bypass -h Quest q333_BlackLionHunt l_info\">Don't hand over."+htmlend
...
u_statue      = html+undiras+"Oh this piece must be?  Although its only part of it still this piece came from one of the statues of Shilen that were lost!  Where in the world did you find it?  Where did you find this sacred object?  This statue is a sacred object for us dark elves.  I will pay you a great sum of money if you will hand it over to me.  After all, it is not of much use to you any way,  right?<br><a action=\"bypass -h Quest q333_BlackLionHunt u_give\">Give him the statue of Shilen.</a><br><a action=\"bypass -h Quest q333_BlackLionHunt u_info\">Refuse to give him the statue of Shilen.</a>"+htmlend
...
m_reward      = html+morgan+"Is there anything I can do for you...?<br><a action=\"bypass -h Quest q333_BlackLionHunt m_give\">Give freight box.</a>"+htmlend

import sys
from com import Config 
