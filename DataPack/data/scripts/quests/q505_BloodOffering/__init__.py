import sys
from com.gameserver.model.entity.sevensigns import SevenSigns
...
from com.gameserver.model.actor.instance import L2PcInstance

qn = "q505_BloodOffering"
...
class Quest (JQuest) :
 ...
 def onTalk (Self, npc, player):
    ...
    st2 = player.getQuestState("q635_InTheDimensionalRift")
    if not st: return
    npcId = npc.getNpcId()
