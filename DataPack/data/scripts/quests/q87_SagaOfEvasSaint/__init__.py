...
class Quest (JQuest) :
 ...
 def __init__(self,id,name,descr):
     ...
     self.NPC = [30191,31626,31588,31280,31620,31646,31649,31653,31654,31655,31657,31280]
     self.Items = [7080,7524,7081,7502,7285,7316,7347,7378,7409,7440,7088,0]
     self.Mob = [27266,27236,27276]
     self.qn = qn
     self.classid = 105
     self.prevclass = 0x1e
     self.X = [164650,46087,46066]
     self.Y = [-74121,-36372,-36396]
     self.Z = [-2871,-1685,-1685]
