...
qn = "q94_SagaOfTheSoultaker"
qnu = 94
qna = "Saga of the Soultaker"
...
class Quest (JQuest) :
 ...
 def __init__(self,id,name,descr):
     ...
     self.NPC = [30832,31623,31279,31279,31645,31646,31648,31650,31654,31655,31657,31279]
     self.Items = [7080,7533,7081,7509,7292,7323,7354,7385,7416,7447,7085,0]
     self.Mob = [27257,27243,27265]
     self.qn = qn
     self.classid = 95
     self.prevclass = 0x0d
